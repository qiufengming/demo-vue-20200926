...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        getData1: function getData1() {
            var self = this;
            self.data1 = [{ name: 'Ueditor 富文本编辑器', routeName: 'Ueditor', routePath: '/ueditor' }, { name: 'Git', routeName: 'git', routePath: '/it/git' }, { name: 'React', routeName: 'react', routePath: '/it/react' }, { name: 'codeDemo', routeName: 'codeDemo', routePath: '/it/codeDemo' }, { name: 'Vue', routeName: 'vue', routePath: '/it/vue' }, { name: 'Vue源码学习', routeName: 'vueCodeLearn', routePath: '/it/vueCodeLearn' }, { name: '面试题', routeName: 'interviewQuestions', routePath: '/it/interviewQuestions' }, { name: 'Kinetic.js', routeName: 'kinetic', routePath: '/it/kinetic' }, { name: 'jsplumb.js', routeName: 'jsplumb', routePath: '/it/jsplumb' }];
        },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sub_Confirm__ = __webpack_require__(199);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Confirm_vue__ = __webpack_require__(200);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__leftNav_vue__ = __webpack_require__(443);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__centerTab_vue__ = __webpack_require__(450);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__right_vue__ = __webpack_require__(459);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__confNavTreeDlg_vue__ = __webpack_require__(445);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: { confNavTreeDlg: __WEBPACK_IMPORTED_MODULE_2__confNavTreeDlg_vue__["a" /* default */] },
    data: function data() {
        return {
            filterText: '',
            defaultProps: {
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(['navTree', 'activeNav'])),
    watch: {
    ...
    methods: {
        ...
        // 打开配置导航树
        openConfNavTreeDlg: function openConfNavTreeDlg() {
            var self = this;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["c" /* mapGetters */])(['navTree'])),
    watch: {
        'confTreeDlg': function confTreeDlg(newVal, oldVal) {
            var self = this;
            if (newVal) {
                self.data = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(self.navTree));
    ...
    methods: {
        ...
        // 编辑
        editNavTree: function editNavTree(row) {
            var self = this;
            self.$set(row, 'isEdit', true);
        },

        // 删除
        delNavTree: function delNavTree(row) {
            var self = this;
        }
    }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fullText_vue__ = __webpack_require__(452);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rule_vue__ = __webpack_require__(455);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: { fullText: __WEBPACK_IMPORTED_MODULE_0__fullText_vue__["a" /* default */], rule: __WEBPACK_IMPORTED_MODULE_1__rule_vue__["a" /* default */] },
    data: function data() {
        return {
            mymsg: '这是第二个页面哦~',
            isRule: false
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
        navData: function navData() {
            var self = this;
            return self.$store.getters.navTree;
        },
        currNav: function currNav() {
            var self = this;
            return self.$store.getters.activeNav;
        }
    }, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(['navTree', 'activeNav'])),
    methods: {
        getMessage: function getMessage(val) {
            alert(val);
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fangfajingjiang_yanyu_pdf01_vue__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fangfajingjiang_panduan_pdf02_vue__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fangfajingjiang_ziliaofenxi_pdf03_vue__ = __webpack_require__(479);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fangfajingjiang_shenlun_pdf04_vue__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fangfajingjiang_shuliangguanxi_pdf05_vue__ = __webpack_require__(487);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elWidthChange_vue__ = __webpack_require__(503);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__flowChart_vue__ = __webpack_require__(506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vuex_index_vue__ = __webpack_require__(510);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: { elWidthChange: __WEBPACK_IMPORTED_MODULE_0__elWidthChange_vue__["a" /* default */], flowChart: __WEBPACK_IMPORTED_MODULE_1__flowChart_vue__["a" /* default */], vuex: __WEBPACK_IMPORTED_MODULE_2__vuex_index_vue__["a" /* default */] },
    data: function data() {
        return {
            isShowDemo: true,
            activeDemo: '3'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__draw__ = __webpack_require__(508);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    created: function created() {
        var self = this;
        self.standardData = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(__WEBPACK_IMPORTED_MODULE_1__draw__["a" /* default */].defaultData));
        self.tTabList = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(__WEBPACK_IMPORTED_MODULE_1__draw__["a" /* default */].defaultTab));
        self.calcPointXY();
    },
    mounted: function mounted() {
        var self = this;
    ...
    methods: {
        ...
        // 计算每个单元连接点的x,y坐标
        calcPointXY: function calcPointXY() {
            var self = this;
            self.standardDataObj = {};

            self.isEndCalc = false;

            self.standardData.forEach(function (item) {
        ...
        calcArrow: function calcArrow() {
            ...
            self.standardData.forEach(function (item) {
                ...
                // 左上
                if (item.lTop.length) {
                    item.lTop.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                // 上
                if (item.top.length) {
                    item.top.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                // 右上
                if (item.rTop.length) {
                    item.rTop.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                // 左
                if (item.left.length) {
                    item.left.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                if (item.right.length) {
                    item.right.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                if (item.lBottom.length) {
                    item.lBottom.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                if (item.bottom.length) {
                    item.bottom.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
                ...
                if (item.rBottom.length) {
                    item.rBottom.forEach(function (line, lineIdx) {
                        if (!line.isStart) {
                            return false;
                        }
        ...
        calcOneArrow: function calcOneArrow(unit, line, lineIdx, endPoint, type) {
            var sX = unit[type + 'X'],
                sY = unit[type + 'Y'],
                eX = endPoint[line.linkPoint + 'X'],
                eY = endPoint[line.linkPoint + 'Y'];
            var oLR = sX - eX > 0 ? 'right' : sX - eX < 0 ? 'left' : 'same';
            var oTB = sY - eY > 0 ? 'bottom' : sY - eY < 0 ? 'top' : 'same';
            var angle = oTB == 'same' ? oLR == 'left' ? 0 : 180 : oLR == 'same' ? oTB == 'top' ? 90 : -90 : 'calc';
            var w = 0;
            if (angle == 'calc') {
                var calcAngle = Math.atan(Math.abs(sY - eY) / Math.abs(sX - eX));
                calcAngle = calcAngle * 180 / Math.PI;
                calcAngle = oLR == 'left' && oTB == 'bottom' ? -calcAngle : oLR == 'left' && oTB == 'top' ? calcAngle : oLR == 'right' && oTB == 'top' ? 180 - calcAngle : -180 + calcAngle;
                angle = calcAngle;
        ...
        // 鼠标移入图元
        enterUnit: function enterUnit(item) {
            var self = this;
            self.$set(item, 'showPoint', true);
        },

        // 鼠标移出图元
        leaveUnit: function leaveUnit(item) {
            var self = this;
            self.$set(item, 'showPoint', false);
        },

        // 鼠标单击图元、箭头
        clickUnit: function clickUnit(type, item) {
            var self = this;
            if (type == 'unit') {
                self.$set(item, 'isSelect', !item.isSelect);
            } else {
                self.standardData.forEach(function (d) {
                    if (d.id == item.unitId) {
        ...
        // 单元鼠标按下事件
        mousedownUnit: function mousedownUnit(evt, item) {
            var self = this;
            var stagePosition = self.$refs.flowChartBox.getBoundingClientRect();
            var unitPosition = evt.currentTarget.getBoundingClientRect();
            var downX = evt.x;
            var downY = evt.y;
        ...
        // 单元鼠标抬起事件
        mouseupUnit: function mouseupUnit(evt, item) {
            var self = this;
        ...
        mousemove: function mousemove(e) {
            ...
            if (self.isMoveUnit) {
                var stagePosition = self.$refs.flowChartBox.getBoundingClientRect();
                var stageX = stagePosition.x;
                var stageY = stagePosition.y;
                var stageW = stagePosition.width;
                var stageH = stagePosition.height;
                var unitPosition = self.currMoveUnit.getBoundingClientRect();
                var mouseX = e.clientX;
                var mouseY = e.clientY;
                var dValL = self.mouseUnit.l;
                var dValR = self.mouseUnit.r;
                var dValT = self.mouseUnit.t;
                var dValB = self.mouseUnit.b;
                // 单元移动
                ...
                var left = mouseX - dValL - 8 <= stageX ? 8 : mouseX - stageX - dValL;
                var top = mouseY - dValT - 8 <= stageY ? 8 : mouseY - stageY - dValT;
            ...
            // 连接线
            if (self.isLigature) {
                var _stagePosition = self.$refs.flowChartBox.getBoundingClientRect();
                var _stageX = _stagePosition.x;
                var _stageY = _stagePosition.y;
                var _stageW = _stagePosition.width;
                var _stageH = _stagePosition.height;
                var sX = self.newArrow.startX,
                    sY = self.newArrow.startY,
                    eX = e.clientX - _stageX - 10,
                    eY = e.clientY - _stageY - 10;
                eX = eX <= 0 ? 0 : eX >= _stageW ? _stageW : eX;
                eY = eY <= 0 ? 0 : eY >= _stageW ? _stageH : eY;
                var calcResult = self.calcAngleWidth(sX, sY, eX, eY);
        ...
        // 点击连接点
        clickPoint: function clickPoint(evt, item, index, type) {
            var self = this;
            if (!self.isLigature) {
                // 开始
                ...
                // self.isEndCalc = false;
                // 结束
                var newEndLine = { isStart: false, linkUnit: 'sn' + self.ligatureEUnit, linkPoint: self.ligatureSPoint };
                self.$set(self.standardData[index], self.ligatureSPoint, self.standardData[index][type].concat([newEndLine]));
                // 开始
                var newStartLine = { isStart: true, linkUnit: 'sn' + item.SN, linkPoint: type };
        ...
        // 计算角度和长度
        calcAngleWidth: function calcAngleWidth(sX, sY, eX, eY) {
            var self = this;
            var angle = 0;
            var arrowW = 0;
            if (sX == eX && sY > eY) {
                ...
                var calcAngle = Math.atan(Math.abs(sY - eY) / Math.abs(sX - eX)); // 计算出角度的弧度制
                calcAngle = calcAngle * 180 / Math.PI; // 计算出角度制
                calcAngle = sX > eX && sY > eY ? -180 + calcAngle : sX < eX && sY > eY ? -calcAngle : sX < eX && sY < eY ? calcAngle : 180 - calcAngle;
                angle = calcAngle;
        ...
        // 表格tab页签点击事件
        tTabClick: function tTabClick(evt, item) {
            var self = this;
        ...
        // 表格tab页签双击事件
        tTabDblclick: function tTabDblclick(evt, item) {
            var self = this;
        ...
        // 表格tab页签输入框失焦
        tTabInputBlur: function tTabInputBlur(evt, item) {
            var self = this;
            self.$set(self.tTab, 'editTab', '');
        },
        ...
        addTab: function addTab() {
            var self = this;
            var newTabIndex = self.tTabList.length + 1;

            var newTab = { id: newTabIndex, name: '新建' + newTabIndex };
            self.$set(self, 'tTabList', self.tTabList.concat(newTab));
            // 选中新建tab
            self.$set(self.tTab, 'editTab', '');
            self.$set(self.tTab, 'active', newTabIndex);
            //
            var newDetailTabTabel = { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' };
            self.standardData.forEach(function (item) {
        ...
        prevStep: function prevStep() {
            var self = this;
            var currStep = self.tTab.currStep;
            var newStep = currStep <= 1 ? 1 : currStep - 1;
        ...
        nextStep: function nextStep() {
            var self = this;
            var currStep = self.tTab.currStep;
            var totalStep = self.standardData.length;
            var newStep = currStep >= totalStep ? totalStep : currStep + 1;
            self.$set(self.tTab, 'currStep', newStep);
        },

        // 双击表格单元格
        cellDblclick: function cellDblclick(prop) {
            var self = this;
            self.$set(self.tTab, 'editCell', prop);
        },

        // 表格单元格输入框失焦
        cellInputBlur: function cellInputBlur() {
            var self = this;
            self.$set(self.tTab, 'editCell', '');
        },
        ...
        openDetails: function openDetails() {
            var self = this;
            var data = [{ id: '1', link: '现状分析（天）' }, { id: '2', link: '根因分析' }, { id: '3', link: '业务目标（天）' }, { id: '4', link: '改进技术目标' }, { id: '5', link: '业界标杆（天）' }];
            var tHead = [];

            self.standardData.forEach(function (item) {
                tHead.push({ label: item.body.text, key: 'step' + Number(item.SN) });

                var d = item.detailTabTabel[self.tTab.active - 1];
        ...
        addUnit: function addUnit() {
            var self = this;
            var len = self.standardData.length;
            var newId = len + 1;
            var newSN = Number(self.standardData[len - 1].SN) + 1 + '';
            if (newSN.length == 1) {
                newSN = '00' + newSN;
            } else if (newSN.length == 2) {
                newSN = '0' + newSN;
            }
            var newX = self.standardData[len - 1].x + 40;
            var newY = self.standardData[len - 1].y + 5;
            var newDetailsTabT = [];
            for (var i = 0; i < self.tTabList.length; i++) {
        ...
        // 删除图元
        delUnit: function delUnit() {
            var self = this;
            // self.$set(item, 'isSelect', !item.isSelect);
            // 删除图元
            for (var i = self.standardData.length - 1; i >= 0; i--) {
                var item = self.standardData[i];
                if (item.isSelect) {
                    self.standardData.splice(i, 1);
                }
                // 
                for (var iLTop = item.lTop.length - 1; iLTop >= 0; iLTop--) {
                    var lTop = item.lTop[iLTop];
                    if (lTop.isSelect) {
                        self.standardData[i].lTop.splice(iLTop, 1);
                    }
                }
                // 
                for (var iTop = item.top.length - 1; iTop >= 0; iTop--) {
                    var top = item.top[iTop];
                    if (top.isSelect) {
                        self.standardData[i].top.splice(iTop, 1);
                    }
                }
                // 
                for (var iRTop = item.rTop.length - 1; iRTop >= 0; iRTop--) {
                    var rTop = item.rTop[iRTop];
                    if (rTop.isSelect) {
                        self.standardData[i].rTop.splice(iRTop, 1);
                    }
                }
                // 
                for (var iLeft = item.left.length - 1; iLeft >= 0; iLeft--) {
                    var left = item.left[iLeft];
                    if (left.isSelect) {
                        self.standardData[i].left.splice(iLeft, 1);
                    }
                }
                // 
                for (var iRight = item.right.length - 1; iRight >= 0; iRight--) {
                    var right = item.right[iRight];
                    if (right.isSelect) {
                        self.standardData[i].right.splice(iRight, 1);
                    }
                }
                // 
                for (var iLBottom = item.lBottom.length - 1; iLBottom >= 0; iLBottom--) {
                    var lBottom = item.lBottom[iLBottom];
                    if (lBottom.isSelect) {
                        self.standardData[i].lBottom.splice(iLBottom, 1);
                    }
                }
                // 
                for (var iBottom = item.bottom.length - 1; iBottom >= 0; iBottom--) {
                    var bottom = item.bottom[iBottom];
                    if (bottom.isSelect) {
                        self.standardData[i].bottom.splice(iBottom, 1);
                    }
                }
                // 
                for (var iRBottom = item.rBottom.length - 1; iRBottom >= 0; iRBottom--) {
                    var rBottom = item.rBottom[iRBottom];
                    if (rBottom.isSelect) {
        ...
        // 编辑图元
        editUnit: function editUnit() {
            var self = this;
        },

        // 清空画布
        cleanUnit: function cleanUnit() {
            var self = this;
        },

        // 加载标准流程
        loadStandard: function loadStandard() {
            var self = this;
        },


        // table单元格双击
        cellDblclick2: function cellDblclick2(row, column, cell, event) {
            var self = this;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elWidthChange_vue__ = __webpack_require__(516);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elWidthChange_vue__ = __webpack_require__(522);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        openCloseModal: function openCloseModal(modalNum) {
            var self = this;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__travel01_vue__ = __webpack_require__(528);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__version01_vue__ = __webpack_require__(534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__version02_vue__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__version03_vue__ = __webpack_require__(540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__version04_vue__ = __webpack_require__(543);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: { version01: __WEBPACK_IMPORTED_MODULE_0__version01_vue__["a" /* default */], version02: __WEBPACK_IMPORTED_MODULE_1__version02_vue__["a" /* default */], version03: __WEBPACK_IMPORTED_MODULE_2__version03_vue__["a" /* default */], version04: __WEBPACK_IMPORTED_MODULE_3__version04_vue__["a" /* default */] },
    data: function data() {
        return {
            isShowList: true,
            active: '',
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        getWorkData: function getWorkData() {
            var self = this;
            self.workExperienceData = [{ time: '2018-10 至 2020-10', company: '上海易宝软件有限公司深圳分公司', post: 'Web 前端开发工程师', size: 'large', color: '#4285F4' },
            // {time: '2017-10 至 2018-09', company: '深圳市零壹金数据科技有限公司', post: 'Web 前端开发工程师', color: '#FBBC05'},
            { time: '2015-12 至 2018-02', company: '天津天地伟业科技有限公司', post: 'Web 前端开发工程师', color: '#34A853' }];
            /*
            self.workExperienceData = [
                {time: 'YYYY-MM 至今', company: 'AAAAAAAAAAAA公司', post: 'Web 前端开发工程师', size: 'large', color: '#4285F4'},
                {time: 'YYYY-MM 至 YYYY-MM', company: 'BBBBBBBBBBBBB科技有限公司', post: 'Web 前端开发工程师', color: '#FBBC05'},
        ...
        getProjectData: function getProjectData() {
            var self = this;
            self.projectData = [{ time: '2020-08 至 2020-09', name: '产品主结构设计', post: 'web 前端开发',
                discript: '该项目主要功能包含两大类：<br/>1、用户输入数据，根据已定好的公式计算出结果，以柱状图展示结果，并支持数据导出。<br/>2、流程图绘制，用户可绘制流程图并数据每个步骤的相应数据，支持数据导出。',
                workContent: '（1）使用vue框架，以及vue-router构建单页面应用。<br/>（2）使用vue+webpack构建项目环境。<br/>（3）使用element插件配合开发。<br/>（4）统计图使用 Echarts展示。<br/>（5）流程图绘制工具为自己编写的功能（因为华为方对外部插件的使用有严格的限制）。',
                size: 'large', color: '#4285F4'
            }, { time: '2020-05 至 2020-09', name: '文档结构化', post: 'web 前端开发',
                discript: '该系统主要实现功能是在线写作，使得文档结构化，可实现多人同时共同编辑同一篇文档。编写完毕后可进行发布供他人在线预览，并作者或管理员可进行后期维护。',
                workContent: '（1）使用vue框架，以及vue-router构建单页面应用。<br/>（2）使用vue+webpack构建项目环境。<br/>（3）使用element插件配合开发。<br/>（4）分别使用UEditor、markdown编辑器实现文档编辑功能。<br/>（5）正文根据滚动定位导航树和相应模块的评论。',
                size: 'large', color: '#4285F4'
            }, { time: '2019-09 至 2020-03', name: '评估度量', post: 'web 前端开发',
                discript: '该项目主要功能是对个个指标数据的展示，编辑，导出等功能',
                workContent: '（1）使用vue框架，以及vue-router构建单页面应用。<br/>（2）使用vue+webpack构建项目环境。<br/>（3）使用element插件配合开发。<br/>（4）使用 echart对数据进行展示，点击柱状图的柱子，统计图显示其子节点的数据。<br/>（5）其中的产品选择使用element的tree实现的。<br/>（6）该项目还有相关的权限配置，及数据导入（上传）功能。上传使用的是element的上传文件组件。',
                size: 'large', color: '#4285F4'
            }, { time: '2018-10 至 2020-01', name: '华为公司内部技术标准规范库', post: 'web 前端开发',
                discript: '规范华为公司内部技术标准规范的管理，指导内部规范的需求、规划、制定、发布、实施、维护等全生命周期活动，形成内部规范端到端的闭环管理机制。',
                workContent: '（1）使用jalor（华为内部）框架构建的传统项目；<br/>（2）使用eclipse进行开发；（3）jalor包含前后端的一个框架，包含前端使用的插件，如：人员选择框、部门选择、树结构、下拉框级连等。',
                size: 'large', color: '#4285F4'
            }, { time: '2016-10 至 2017-12', name: '功夫中国门户网站', post: 'web 前端开发',
                discript: '该平台由三部分组成，即：后台管理系统、PC 端门户网站和手机 APP，其中手机 APP 又包括 android 版和 IOS 版本。该系统是集新闻资讯、赛事直播、直播室聊天、送礼物、发弹幕、视频回放、现场门票购买、特卫预约、学员招募、赛事定制、会员充值、赛事竞猜、词条编写等为一体的门户网站。',
                workContent: '（1）前端页面开发使用HTML（5）、CSS（3）、JavaScript、jQuery实现；<br/>（2）通过Ajax实现前后台数据处理；<br/>（3）Web前端页面开发主要使用到的插件：Bootstrap、easyUI、eCharts...<br/>（4）页面的轮播图使用的Bootstrap的Carousel插件；<br/>（5）页面弹出框部分使用了easyUI的dialog，部分使用了Bootstrap的模态框；<br/>（6）安保预约中的地点及联系我们中的地图使用的是百度地图。<br/>（7）管理数据的表格及查询搜索框使用的是jQuery-easyUI插件；<br/>（8）信息添加使用easyUI的dialog插件。',
                size: 'large', color: '#34A853'
            }, { time: '2015-12 至 2016-07', name: '株洲市城市建设管理及公共信息平台', post: 'web 前端开发',
                discript: '该项目包括以下几个系统：<br/>（1）节能减排评价与推广平台<br/>（2）节能减排评价与推广平台后台管理系统<br/>（3）建筑工程安监应用平台<br/>（4）燃气信息系统<br/>（5）污水处理信息系统<br/>（6）自来水信息系统<br/>（7）垃圾处理信息系统<br/>（8）平台后台管理系统',
                workContent: '（1）使用HTML（5）、CSS、JavaScript、jQuery实现前端页面的开发；<br/>（2）通过Ajax实现前后台数据处理；<br/>（3）其中的树及部分插件使用的是jQuery-easyUI插件；<br/>（4）能耗统计图使用的是eCharts插件；<br/>（5）首页的电子地图使用的是百度地图；<br/>（6）前端还使用了Bootstrap插件。', size: 'large', color: '#34A853'
            }];
        }
    }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_vue__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__es6_vue__ = __webpack_require__(552);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_vue__ = __webpack_require__(555);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__draw__ = __webpack_require__(573);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])( // 语法糖
    ['modifyAName'] // 相当于this.$store.dispatch('modifyName'),提交这个方法
    ), {
        trunToB: function trunToB() {
            this.$router.push({ path: '/it/codeDemo/vuex/b' }); // 路由跳转到B
        }
    }),
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(['resturantName']))
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    ['modifyBName'] // 相当于this.$store.dispatch('modifyName'),提交这个方法
        ...
        trunToA: function trunToA() {
            this.$router.push({ path: '/it/codeDemo/vuex/a' }); // 路由跳转到A
        }
    }),
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(['resturantName']))
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_element_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App__ = __webpack_require__(415);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__router__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_element_ui_lib_theme_chalk_index_css__ = __webpack_require__(581);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_common_css__ = __webpack_require__(582);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store_index__ = __webpack_require__(583);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__script_globalVariable__ = __webpack_require__(587);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_echarts__ = __webpack_require__(588);
...
new __WEBPACK_IMPORTED_MODULE_0_vue__["default"]({
  ...
  store: __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */], // 这样就能全局使用vuex了
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(194);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index__ = __webpack_require__(421);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_home_index__ = __webpack_require__(424);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_HelloWorld__ = __webpack_require__(427);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_views_First__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_views_Second__ = __webpack_require__(435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_ueditor_Ueditor__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_works_docStructure_index__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_learn_index__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_learn_gongwuyuan_index__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_learn_gongwuyuan_pdf__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_it_index__ = __webpack_require__(492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_it_git_index__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_it_react_index__ = __webpack_require__(498);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_it_codeDemo_index__ = __webpack_require__(501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_it_vue_index__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_it_vueCodeLearn_index__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_other_travel_index__ = __webpack_require__(526);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_works_resume_index__ = __webpack_require__(532);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_it_interviewQuestions_index__ = __webpack_require__(547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_it_kinetic_index__ = __webpack_require__(559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_works_kineticjs_index__ = __webpack_require__(562);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_it_jsplumb_index__ = __webpack_require__(565);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_index__ = __webpack_require__(568);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_flowChart_index__ = __webpack_require__(571);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_it_codeDemo_vuex_A__ = __webpack_require__(575);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_it_codeDemo_vuex_B__ = __webpack_require__(578);
  ...
  routes: [{
    ...
    children: [{
      ...
      children: [{
        ...
        name: 'codeDemoVueXA',
        component: __WEBPACK_IMPORTED_MODULE_26__pages_it_codeDemo_vuex_A__["a" /* default */]
      }, {
        path: 'codeDemo/vuex/b',
        name: 'codeDemoVueXB',
        component: __WEBPACK_IMPORTED_MODULE_27__pages_it_codeDemo_vuex_B__["a" /* default */]
      }, {
        path: 'vue',
        name: 'vue',
        ...
        path: 'vueCodeLearn',
        name: 'vueCodeLearn',
        component: __WEBPACK_IMPORTED_MODULE_17__pages_it_vueCodeLearn_index__["a" /* default */]
      }, {
        path: 'interviewQuestions',
        name: 'interviewQuestions',
        component: __WEBPACK_IMPORTED_MODULE_20__pages_it_interviewQuestions_index__["a" /* default */]
      }, {
        path: 'kinetic',
        name: 'kinetic',
        component: __WEBPACK_IMPORTED_MODULE_21__pages_it_kinetic_index__["a" /* default */]
      }, {
        path: 'jsplumb',
        name: 'jsplumb',
        component: __WEBPACK_IMPORTED_MODULE_23__pages_it_jsplumb_index__["a" /* default */]
      }]
    }, {
      path: 'travel',
      name: 'travel',
      component: __WEBPACK_IMPORTED_MODULE_18__pages_other_travel_index__["a" /* default */]
    }, {
      path: '/works/resume',
      name: 'resume',
      component: __WEBPACK_IMPORTED_MODULE_19__pages_works_resume_index__["a" /* default */]
    }, {
      path: '/works/kineticFlowCahrt',
      name: 'kineticFlowCahrt',
      component: __WEBPACK_IMPORTED_MODULE_22__pages_works_kineticjs_index__["a" /* default */]
    }, {
      path: '/components',
      component: __WEBPACK_IMPORTED_MODULE_24__components_index__["default"],
      children: [{
        path: 'flowChart',
        name: 'flowChart',
        component: __WEBPACK_IMPORTED_MODULE_25__components_flowChart_index__["a" /* default */]
      }]
    }]
  }]
}));
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c52ed778_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(426);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-c52ed778"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c52ed778_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_HelloWorld_vue__ = __webpack_require__(197);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_First_vue__ = __webpack_require__(198);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Second_vue__ = __webpack_require__(201);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ueditor_vue__ = __webpack_require__(202);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_leftNav_vue__ = __webpack_require__(204);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_172fce3e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_leftNav_vue__ = __webpack_require__(449);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-172fce3e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_172fce3e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_leftNav_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_confNavTreeDlg_vue__ = __webpack_require__(205);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f80307f8_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_confNavTreeDlg_vue__ = __webpack_require__(448);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-f80307f8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_confNavTreeDlg_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f80307f8_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_confNavTreeDlg_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-dialog',{attrs:{"title":"配置导航树","visible":_vm.confTreeDlg,"width":"90%","close-on-click-modal":false},on:{"update:visible":function($event){_vm.confTreeDlg=$event}}},[_c('el-table',{staticStyle:{"width":"100%","margin-bottom":"20px"},attrs:{"data":_vm.data,"height":"300","row-key":"id","border":"","default-expand-all":"","tree-props":{children: 'children', hasChildren: 'hasChildren'}}},[_c('el-table-column',{attrs:{"prop":"label","label":"名称","sortable":"","width":"230"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.isEdit)?_c('el-input',{attrs:{"type":"text","placeholder":"请输入导航名称","maxlength":"255","show-word-limit":""},model:{value:(scope.row.label),callback:function ($$v) {_vm.$set(scope.row, "label", $$v)},expression:"scope.row.label"}}):_c('span',[_vm._v(" "+_vm._s(scope.row.label)+" ")])]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"author","label":"作者","sortable":"","width":"180"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.isEdit)?_c('el-input',{attrs:{"type":"text","placeholder":"请输入作者","maxlength":"255","show-word-limit":""},model:{value:(scope.row.author),callback:function ($$v) {_vm.$set(scope.row, "author", $$v)},expression:"scope.row.author"}}):_c('span',[_vm._v(" "+_vm._s(scope.row.author)+" ")])]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"intro","label":"简介","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.isEdit)?_c('el-input',{attrs:{"type":"text","placeholder":"请输入简介","maxlength":"255","show-word-limit":""},model:{value:(scope.row.intro),callback:function ($$v) {_vm.$set(scope.row, "intro", $$v)},expression:"scope.row.intro"}}):_c('span',[_vm._v(" "+_vm._s(scope.row.intro)+" ")])]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"fixed":"right","label":"操作","width":"100"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('el-button',{attrs:{"type":"text","size":"small"},on:{"click":function($event){return _vm.delNavTree(scope.row)}}},[_vm._v("删除")]),_vm._v(" "),_c('el-button',{attrs:{"type":"text","size":"small"},on:{"click":function($event){return _vm.editNavTree(scope.row)}}},[_vm._v("编辑")])]}}])})],1),_vm._v(" "),_c('span',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{on:{"click":_vm.closeDlg}},[_vm._v("取 消")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":_vm.saveDlg}},[_vm._v("确 定")])],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"left-nav"},[_c('el-row',[_c('el-col',{attrs:{"span":20}},[_c('el-input',{attrs:{"placeholder":"输入关键字进行过滤"},model:{value:(_vm.filterText),callback:function ($$v) {_vm.filterText=$$v},expression:"filterText"}})],1),_vm._v(" "),_c('el-col',{staticStyle:{"font-size":"24px","text-align":"center","line-height":"40px"},attrs:{"span":4}},[_c('i',{staticClass:"el-icon-s-tools",on:{"click":_vm.openConfNavTreeDlg}})])],1),_vm._v(" "),_c('el-tree',{ref:"tree",staticClass:"filter-tree",attrs:{"data":_vm.navTree,"props":_vm.defaultProps,"node-key":"id","default-expand-all":"","filter-node-method":_vm.filterNode,"expand-on-click-node":false},on:{"node-click":_vm.nodeClick}}),_vm._v(" "),_c('confNavTreeDlg',{attrs:{"confTreeDlg":_vm.confTreeDlg},on:{"update:confTreeDlg":function($event){_vm.confTreeDlg=$event},"update:conf-tree-dlg":function($event){_vm.confTreeDlg=$event}}})],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_centerTab_vue__ = __webpack_require__(206);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_560053e8_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_centerTab_vue__ = __webpack_require__(458);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-560053e8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_560053e8_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_centerTab_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_fullText_vue__ = __webpack_require__(207);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__ = __webpack_require__(208);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c1bb3d5_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__ = __webpack_require__(457);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6c1bb3d5"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c1bb3d5_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"rule_wrap"},[_vm._v("\n    规则\n    "),_c('div',[_vm._v("当前规则的ID： "+_vm._s(_vm.currNav))])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"center-tab"},[_c('el-tabs',{attrs:{"type":"border-card"}},[_c('el-tab-pane',[_c('span',{attrs:{"slot":"label"},slot:"label"},[_c('i',{staticClass:"el-icon-date"}),_vm._v(" 全文")]),_vm._v(" "),_c('fullText')],1),_vm._v(" "),_c('el-tab-pane',{attrs:{"label":"规则"}},[_c('rule')],1),_vm._v(" "),_c('el-tab-pane',{attrs:{"label":"相关规则"}},[_vm._v("相关规则")])],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_right_vue__ = __webpack_require__(209);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf_vue__ = __webpack_require__(212);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf01_vue__ = __webpack_require__(213);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf02_vue__ = __webpack_require__(214);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf03_vue__ = __webpack_require__(215);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf04_vue__ = __webpack_require__(216);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pdf05_vue__ = __webpack_require__(217);
/* unused harmony namespace reexport */
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4107837e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(513);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4107837e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4107837e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_elWidthChange_vue__ = __webpack_require__(222);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_flowChart_js__ = __webpack_require__(223);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04b93ac6_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_flowChart_vue__ = __webpack_require__(509);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_flowChart_js__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04b93ac6_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_flowChart_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var draw = {
    defaultData: [{
        ...
        lBottom: [],
        left: [],
        detailTabTabel: [{ currAnalyse: '0.01', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.05', rootCause: '', business: '0.05', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.01' }]
    }, { id: '2', SN: '002', x: 156, y: 100, head: { text: '002-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'bbbbbbb', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#92d050' }, footer: { text: '滚蛋吧', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn003', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn001', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }, { currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }, { currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }] }, { id: '3', SN: '003', x: 282, y: 100, head: { text: '003-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'cccccc', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '发给你答复', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn004', linkPoint: 'left' }, { isStart: true, linkUnit: 'sn005', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn002', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '1', rootCause: '刷副本', business: '0.1', improveTec: '闪电风暴', industryMark: '0.1' }, { currAnalyse: '1', rootCause: '1.C-S关系多对一、多对多，华为、客户编码的颗粒度不同，需手工生成BOQ', business: '0.2', improveTec: '消除C-S多对多、多对一', industryMark: '0.1' }, { currAnalyse: '1', rootCause: '1.C-S关系多对一、多对多，华为、客户编码的颗粒度不同，需手工生成BOQ', business: '0.2', improveTec: '消除C-S多对多、多对一', industryMark: '0.1' }] }, { id: '4', SN: '004', x: 408, y: 34, head: { text: '004-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'dddd', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '打个包大哥', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn006', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn003', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '上刊登', business: '0.1', improveTec: '消除备注、插入和扩位编码', industryMark: '0.1' }, { currAnalyse: '1', rootCause: 'djfdhn', business: '0.2', improveTec: '消除备注、插入和扩位编码', industryMark: '0.1' }, { currAnalyse: '1', rootCause: '定制与选配件，通过备注/插入，或申请扩位编码，需进行解决方案评审，并且研发要进行定制化开发', business: '0.2', improveTec: '消除备注、插入和扩位编码', industryMark: '0.1' }] }, { id: '5', SN: '005', x: 408, y: 166, head: { text: '005-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'ede', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#92d050' }, footer: { text: '都送给你的', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn006', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn003', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }] }, { id: '6', SN: '006', x: 534, y: 100, head: { text: '006-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'dsfbd', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '地方干部', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn007', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn004', linkPoint: 'right' }, { isStart: false, linkUnit: 'sn004', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }, { currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }, { currAnalyse: '0', rootCause: '', business: '0', improveTec: '', industryMark: '0' }] }, { id: '7', SN: '007', x: 660, y: 100, head: { text: '007-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '哈哈', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '电饭煲的', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn008', linkPoint: 'left' }, { isStart: true, linkUnit: 'sn009', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn006', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.5', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.3', rootCause: '', business: '0.3', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0', rootCause: '', business: '0.4', improveTec: '', industryMark: '0.2' }] }, { id: '8', SN: '008', x: 786, y: 34, head: { text: '008-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '听歌', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '富豪们', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn010', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn007', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '1', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.6', rootCause: '', business: '0.6', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.3', rootCause: '', business: '0.2', improveTec: '', industryMark: '0.01' }] }, { id: '9', SN: '009', x: 786, y: 166, head: { text: '009-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '恩特', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '水电费', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn010', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn007', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }] }, { id: '10', SN: '010', x: 912, y: 100, head: { text: '010-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: 'Ethan', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#92d050' }, footer: { text: '撒地方v', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn011', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn008', linkPoint: 'right' }, { isStart: false, linkUnit: 'sn009', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.01', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.3' }, { currAnalyse: '0.05', rootCause: '', business: '0.05', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.05', rootCause: '', business: '0.05', improveTec: '', industryMark: '0.01' }] }, { id: '11', SN: '011', x: 1038, y: 100, head: { text: '011-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '让人颓废和', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#92d050' }, footer: { text: '是大V', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn012', linkPoint: 'left' }, { isStart: true, linkUnit: 'sn013', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn010', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.01', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.02' }, { currAnalyse: '0.5', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.5', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.01' }] }, { id: '12', SN: '012', x: 1164, y: 34, head: { text: '012-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#92d050' }, footer: { text: '', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn015', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn011', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }] }, { id: '13', SN: '013', x: 1164, y: 166, head: { text: '013-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '发给你', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '发布', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn014', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn011', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.5', rootCause: '只要走定制开发流程，即使微小变化，走流程也需要3~5天', business: '0.01', improveTec: '客制方案在配置器上即可完成', industryMark: '0.01' }, { currAnalyse: '0.5', rootCause: '只要走定制开发流程，即使微小变化，走流程也需要3~5天', business: '0.01', improveTec: '客制方案在配置器上即可完成', industryMark: '0.01' }, { currAnalyse: '0.5', rootCause: '只要走定制开发流程，即使微小变化，走流程也需要3~5天', business: '0.01', improveTec: '客制方案在配置器上即可完成', industryMark: '0.01' }] }, { id: '14', SN: '014', x: 1290, y: 166, head: { text: '014', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '的咖啡机', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: true, linkUnit: 'sn015', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: false, linkUnit: 'sn013', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }, { currAnalyse: '', rootCause: '', business: '', improveTec: '', industryMark: '' }] }, { id: '15', SN: '015', x: 1416, y: 34, head: { text: '015-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '是发布电饭煲的', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '撒地方v', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [], rBottom: [], bottom: [{ isStart: true, linkUnit: 'sn016', linkPoint: 'top' }], lBottom: [], left: [{ isStart: false, linkUnit: 'sn012', linkPoint: 'right' }, { isStart: false, linkUnit: 'sn014', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '1', rootCause: '人工确认信息多：齐套、需求、订单、备注等', business: '1', improveTec: '消除订单备注', industryMark: '0.5' }, { currAnalyse: '0.5', rootCause: '人工确认信息多：齐套、需求、订单、备注等', business: '0.5', improveTec: '消除订单备注', industryMark: '0.5' }, { currAnalyse: '0.5', rootCause: '人工确认信息多：齐套、需求、订单、备注等', business: '0.5', improveTec: '消除订单备注', industryMark: '0.5' }] }, { id: '16', SN: '016', x: 1416, y: 334, head: { text: '016-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '的发布大风', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '是发v', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [{ isStart: false, linkUnit: 'sn015', linkPoint: 'bottom' }], rTop: [], right: [], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn017', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.5', rootCause: '物料齐套、急单、来料缺陷；调仓等操作', business: '0.5', improveTec: '减少低发货物料编码、消除扩位编码、降低来料缺陷', industryMark: '1.667' }, { currAnalyse: '5', rootCause: '物料齐套、急单、来料缺陷；调仓等操作', business: '0.5', improveTec: '减少低发货物料编码、消除扩位编码、降低来料缺陷', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '物料齐套、急单、来料缺陷；调仓等操作', business: '1', improveTec: '减少低发货物料编码、消除扩位编码、降低来料缺陷', industryMark: '0.5' }] }, { id: '17', SN: '017', x: 1290, y: 334, head: { text: '017-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '三发挥', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: 'SPS', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn016', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn018', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '只要按订单分料、投递，就至少需要1天时间', business: '0.5', improveTec: '90%订单不需按客户订单投递', industryMark: '0' }, { currAnalyse: '0.5', rootCause: '只要按订单分料、投递，就至少需要1天时间', business: '0.5', improveTec: '90%订单不需按客户订单投递', industryMark: '0' }, { currAnalyse: '1', rootCause: '只要按订单分料、投递，就至少需要1天时间', business: '0.5', improveTec: '90%订单不需按客户订单投递', industryMark: '0' }] }, { id: '18', SN: '018', x: 1164, y: 334, head: { text: '018-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '萨芬干撒发v撒发v', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '是否VB', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn017', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn019', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '4', rootCause: '急单带来备货齐套问题（PO比20%）EC更改带来备料问题（PO比20%）EC、备注确认等（PO占比10~20%）包材备料7~15天备货到产线1天', business: '1', improveTec: '90%产线实现3天冻结，实现物料准备0天，备货到产线0天，消除EC/备注', industryMark: '1' }, { currAnalyse: '3', rootCause: '急单带来备货齐套问题（PO比20%）EC更改带来备料问题（PO比20%）EC、备注确认等（PO占比10~20%）包材备料7~15天备货到产线1天', business: '1', improveTec: '90%产线实现3天冻结，实现物料准备0天，备货到产线0天，消除EC/备注', industryMark: '1' }, { currAnalyse: '4', rootCause: '急单带来备货齐套问题（PO比20%）EC更改带来备料问题（PO比20%）EC、备注确认等（PO占比10~20%）包材备料7~15天备货到产线1天', business: '1', improveTec: '90%产线实现3天冻结，实现物料准备0天，备货到产线0天，消除EC/备注', industryMark: '1' }] }, { id: '19', SN: '019', x: 1038, y: 334, head: { text: '019-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '打副本电饭煲的', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '电饭煲', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn018', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn020', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '产品种类多，换线多（基本每条线每天换1次，4~8小时。HR每月生产69个编码，半年新导入108个新产品；HH2月126个编码）', business: '0.5', improveTec: '提升效率', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '产品种类多，换线多（基本每条线每天换1次，4~8小时。HR每月生产69个编码，半年新导入108个新产品；HH2月126个编码）', business: '0.5', improveTec: '提升效率', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '产品种类多，换线多（基本每条线每天换1次，4~8小时。HR每月生产69个编码，半年新导入108个新产品；HH2月126个编码）', business: '0.5', improveTec: '提升效率', industryMark: '0.5' }] }, { id: '20', SN: '020', x: 912, y: 334, head: { text: '020-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '我仍然不', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '是大V', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn019', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn021', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '5', rootCause: '1. 总装配时间500min 2. 新产品多，装配学习多0.5天 3. 来料不良的生产停顿，一般0.5天（占比10~20%） 4. 插框装配时间长，一般300min', business: '1', improveTec: '消除80%的新品学习周期降低来料不良缺陷 90%订单按客户要求延迟装配按订单装配的总装时间1小时', industryMark: '1' }, { currAnalyse: '4', rootCause: '1. 总装配时间500min 2. 新产品多，装配学习多0.5天 3. 来料不良的生产停顿，一般0.5天（占比10~20%） 4. 插框装配时间长，一般300min', business: '2', improveTec: '消除80%的新品学习周期降低来料不良缺陷 90%订单按客户要求延迟装配按订单装配的总装时间1小时', industryMark: '1' }, { currAnalyse: '4.6', rootCause: '1. 总装配时间500min 2. 新产品多，装配学习多0.5天 3. 来料不良的生产停顿，一般0.5天（占比10~20%） 4. 插框装配时间长，一般300min', business: '1', improveTec: '消除80%的新品学习周期降低来料不良缺陷 90%订单按客户要求延迟装配按订单装配的总装时间1小时', industryMark: '1' }] }, { id: '21', SN: '021', x: 786, y: 334, head: { text: '021-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '咦咦了', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#FF9800' }, footer: { text: '是大润发', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn020', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn022', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '需预约IQC作检查，一批机柜需要1天', business: '0.5', improveTec: '', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '需预约IQC作检查，一批机柜需要1天', business: '0.5', improveTec: '', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '需预约IQC作检查，一批机柜需要1天', business: '0.5', improveTec: '', industryMark: '0.5' }] }, { id: '22', SN: '022', x: 660, y: 334, head: { text: '022-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '温柔哥', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#676767' }, footer: { text: '切', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn021', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn023', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '0.5', rootCause: '', business: '0.01', improveTec: '', industryMark: '0.01' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }] }, { id: '23', SN: '023', x: 534, y: 334, head: { text: '023-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '凶了', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#676767' }, footer: { text: '污染', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn022', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn024', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }] }, { id: '24', SN: '024', x: 408, y: 334, head: { text: '024-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '我说如果', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#676767' }, footer: { text: '是否', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn023', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [{ isStart: true, linkUnit: 'sn025', linkPoint: 'right' }], detailTabTabel: [{ currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0' }, { currAnalyse: '2', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.5' }] }, { id: '25', SN: '025', x: 282, y: 334, head: { text: '025-', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, body: { text: '爱的发的', color: '#ffffff', fontFamily: 'Microsoft YaHei', bgColor: '#676767' }, footer: { text: 'sdfv ', color: '#0e0d0d', fontFamily: 'Microsoft YaHei', bgColor: '#ffffff' }, lTop: [], top: [], rTop: [], right: [{ isStart: false, linkUnit: 'sn024', linkPoint: 'left' }], rBottom: [], bottom: [], lBottom: [], left: [], detailTabTabel: [{ currAnalyse: '1', rootCause: '', business: '0.5', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.6', rootCause: '', business: '0.6', improveTec: '', industryMark: '0.01' }, { currAnalyse: '0.3', rootCause: '', business: '0.2', improveTec: '', industryMark: '0.01' }] }],
    defaultDataObj: {},
    defaultTab: [{ id: 1, name: '万能插框分析' }, { id: 2, name: 'ATN' }, { id: 3, name: 'IT服务器' }]
};
// 计算每个单元连接点的x,y坐标
...
draw.calcArrow = function (data, dataObj) {
    ...
    data.forEach(function (item) {
        ...
        // 左上
        if (item.lTop.length) {
            item.lTop.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 上
        if (item.top.length) {
            item.top.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 右上
        if (item.rTop.length) {
            item.rTop.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 左
        if (item.left.length) {
            item.left.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 右
        if (item.right.length) {
            item.right.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 左下
        if (item.lBottom.length) {
            item.lBottom.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 下
        if (item.bottom.length) {
            item.bottom.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
        ...
        // 右下
        if (item.rBottom.length) {
            item.rBottom.forEach(function (line) {
                if (!line.isStart) {
                    return false;
                }
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"dfsc_lt_wrap"},[_c('el-tabs',{attrs:{"type":"card"},on:{"tab-click":_vm.handleClick},model:{value:(_vm.activeName),callback:function ($$v) {_vm.activeName=$$v},expression:"activeName"}},[_c('el-tab-pane',{attrs:{"label":"标准流程","name":"1"}}),_vm._v(" "),_c('el-tab-pane',{attrs:{"label":"自定义流程","name":"2"}})],1),_vm._v(" "),_c('el-row',{directives:[{name:"show",rawName:"v-show",value:(_vm.activeName == '2'),expression:"activeName == '2'"}],staticClass:"canvas_toolbar"},[_c('div',{ref:"section",staticClass:"section",attrs:{"id":"toolbar"}},[_c('el-button',{ref:"add",attrs:{"id":"add","size":"mini"},on:{"click":_vm.addUnit}},[_vm._v("新增图元")]),_vm._v(" "),_c('el-button',{ref:"del",attrs:{"id":"del","size":"mini"},on:{"click":_vm.delUnit}},[_vm._v("删除图元")]),_vm._v(" "),_c('el-button',{ref:"editProp",attrs:{"id":"editProp","size":"mini"},on:{"click":_vm.editUnit}},[_vm._v("编辑图元")]),_vm._v(" "),_c('el-button',{ref:"clear",attrs:{"id":"clear","size":"mini"},on:{"click":_vm.cleanUnit}},[_vm._v("清除画布")]),_vm._v(" "),_c('el-button',{ref:"standard",attrs:{"id":"standard","size":"mini"},on:{"click":_vm.loadStandard}},[_vm._v("加载标准流程")])],1)]),_vm._v(" "),_c('el-row',{staticClass:"flow_chart_wrap"},[_c('div',{ref:"flowChartBox",staticClass:"flow_chart_box",attrs:{"id":"flowChartBox"}},[_vm._l((_vm.standardData),function(item,i){return _c('div',{key:i,staticClass:"unit_wrap",style:({left: item.x+'px', top: item.y+'px'}),on:{"mouseenter":function($event){return _vm.enterUnit(item)},"mouseleave":function($event){return _vm.leaveUnit(item)},"click":function($event){return _vm.clickUnit('unit', item)},"mousedown":function($event){return _vm.mousedownUnit($event, item)},"mouseup":function($event){return _vm.mouseupUnit($event,item)}}},[(item.SN !='mouse')?_c('div',{staticClass:"unit",style:({'border-color': item.isSelect?'red':''})},[_c('p',{staticClass:"head",style:({'background-color': item.head.bgColor, color: item.head.color, 'font-family': item.head.fontFamily})},[_vm._v(_vm._s(item.head.text))]),_vm._v(" "),_c('div',{staticClass:"body",style:({'background-color': item.body.bgColor, color: item.body.color, 'font-family': item.body.fontFamily})},[_vm._v(_vm._s(item.body.text))]),_vm._v(" "),_c('p',{staticClass:"foot",style:({'background-color': item.footer.bgColor, color: item.footer.color, 'font-family': item.footer.fontFamily})},[_vm._v(_vm._s(item.footer.text))])]):_vm._e(),_vm._v(" "),(item.SN !='mouse')?_c('div',{directives:[{name:"show",rawName:"v-show",value:(item.showPoint),expression:"item.showPoint"}],staticClass:"point_wrap"},[_c('span',{staticClass:"point lTop",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'lTop')}}}),_vm._v(" "),_c('span',{staticClass:"point top",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'top')}}}),_vm._v(" "),_c('span',{staticClass:"point rTop",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'rTop')}}}),_vm._v(" "),_c('span',{staticClass:"point right",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'right')}}}),_vm._v(" "),_c('span',{staticClass:"point rBottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'rBottom')}}}),_vm._v(" "),_c('span',{staticClass:"point bottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'bottom')}}}),_vm._v(" "),_c('span',{staticClass:"point lBottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'lBottom')}}}),_vm._v(" "),_c('span',{staticClass:"point left",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'left')}}})]):_vm._e()])}),_vm._v(" "),_c('div',{staticClass:"arrow_wrap"},[_vm._l((_vm.arrowArr),function(item,i){return _c('div',{key:i,staticClass:"arrow",style:({
                ...
                }),on:{"click":function($event){$event.stopPropagation();return _vm.clickUnit('arrow', item)}}},[_c('div',{staticClass:"arrow_r",style:({ 'border-left-color':item.isSelect?'red':'' }),on:{"click":function($event){$event.stopPropagation();return _vm.clickUnit('arrow', item)}}})])}),_vm._v(" "),(_vm.newArrow!==null)?_c('div',{staticClass:"arrow arrow_r",style:({
                    width: _vm.newArrow.width+'px', left: _vm.newArrow.startX+8+'px', top: _vm.newArrow.startY+8+'px', 
                    transform: 'rotate('+_vm.newArrow.angle+'deg)', '-ms-transform': 'rotate('+_vm.newArrow.angle+'deg)', '-webkit-transform': 'rotate('+_vm.newArrow.angle+'deg)',
                })}):_vm._e()],2)],2),_vm._v(" "),_c('div',{ref:"propsEdit",staticClass:"props_edit",attrs:{"id":"props_edit"}})]),_vm._v(" "),_c('el-row',[_c('div',{staticClass:"t_tab_wrap"},[_vm._l((_vm.tTabList),function(item,i){return _c('label',{key:'t_tab_'+i,staticClass:"t_tab",class:_vm.tTab.active == item.id?'activeTTab': ''},[_c('span',{directives:[{name:"show",rawName:"v-show",value:(_vm.tTab.editTab!=item.id),expression:"tTab.editTab!=item.id"}],staticClass:"t_tab_text",on:{"dblclick":function($event){return _vm.tTabDblclick($event, item)},"click":function($event){return _vm.tTabClick($event, item)}}},[_vm._v(_vm._s(item.name))]),_vm._v(" "),_c('el-input',{directives:[{name:"show",rawName:"v-show",value:(_vm.tTab.editTab==item.id),expression:"tTab.editTab==item.id"}],attrs:{"width":"160","placeholder":"请输入内容","maxlength":"50"},on:{"blur":function($event){return _vm.tTabInputBlur($event, item)}},model:{value:(item.name),callback:function ($$v) {_vm.$set(item, "name", $$v)},expression:"item.name"}})],1)}),_vm._v(" "),_c('el-button',{ref:"tTabAdd",staticClass:"t_tab_add",attrs:{"size":"mini","type":"text"},on:{"click":_vm.addTab}},[_vm._v("+")]),_vm._v(" "),_c('el-button',{ref:"tTabDetail",staticClass:"t_tab_detail",attrs:{"size":"mini","type":"text"},on:{"click":_vm.openDetails}},[_c('i',{staticClass:"el-icon-s-operation"})])],2)]),_vm._v(" "),_c('el-row',{staticClass:"t_wrap"},[_c('el-row',{staticClass:"t_head"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].body.text))]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}})],1),_vm._v(" "),_c('el-row',{staticClass:"t_body"},[_c('el-row',{staticClass:"t_tr"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v("现状分析（天）")]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[(_vm.tTab.editCell == 'currAnalyse')?_c('el-input',{attrs:{"placeholder":"请输入内容","clearable":""},on:{"blur":_vm.cellInputBlur},model:{value:(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].currAnalyse),callback:function ($$v) {_vm.$set(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1], "currAnalyse", $$v)},expression:"standardData[tTab.currStep-1].detailTabTabel[tTab.active-1].currAnalyse"}}):_c('span',{staticClass:"cell",on:{"dblclick":function($event){return _vm.cellDblclick('currAnalyse')}}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].currAnalyse))])],1)],1),_vm._v(" "),_c('el-row',{staticClass:"t_tr"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v("根因分析")]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[(_vm.tTab.editCell == 'rootCause')?_c('el-input',{attrs:{"placeholder":"请输入内容","clearable":""},on:{"blur":_vm.cellInputBlur},model:{value:(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].rootCause),callback:function ($$v) {_vm.$set(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1], "rootCause", $$v)},expression:"standardData[tTab.currStep-1].detailTabTabel[tTab.active-1].rootCause"}}):_c('span',{staticClass:"cell",on:{"dblclick":function($event){return _vm.cellDblclick('rootCause')}}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].rootCause))])],1)],1),_vm._v(" "),_c('el-row',{staticClass:"t_tr"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v("业务目标（天）")]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[(_vm.tTab.editCell == 'business')?_c('el-input',{attrs:{"placeholder":"请输入内容","clearable":""},on:{"blur":_vm.cellInputBlur},model:{value:(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].business),callback:function ($$v) {_vm.$set(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1], "business", $$v)},expression:"standardData[tTab.currStep-1].detailTabTabel[tTab.active-1].business"}}):_c('span',{staticClass:"cell",on:{"dblclick":function($event){return _vm.cellDblclick('business')}}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].business))])],1)],1),_vm._v(" "),_c('el-row',{staticClass:"t_tr"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v("改进技术目标")]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[(_vm.tTab.editCell == 'improveTec')?_c('el-input',{attrs:{"placeholder":"请输入内容","clearable":""},on:{"blur":_vm.cellInputBlur},model:{value:(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].improveTec),callback:function ($$v) {_vm.$set(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1], "improveTec", $$v)},expression:"standardData[tTab.currStep-1].detailTabTabel[tTab.active-1].improveTec"}}):_c('span',{staticClass:"cell",on:{"dblclick":function($event){return _vm.cellDblclick('improveTec')}}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].improveTec))])],1)],1),_vm._v(" "),_c('el-row',{staticClass:"t_tr"},[_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[_vm._v("业界标杆（天）")]),_vm._v(" "),_c('el-col',{staticClass:"t_td",attrs:{"span":12}},[(_vm.tTab.editCell == 'industryMark')?_c('el-input',{attrs:{"placeholder":"请输入内容","clearable":""},on:{"blur":_vm.cellInputBlur},model:{value:(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].industryMark),callback:function ($$v) {_vm.$set(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1], "industryMark", $$v)},expression:"standardData[tTab.currStep-1].detailTabTabel[tTab.active-1].industryMark"}}):_c('span',{staticClass:"cell",on:{"dblclick":function($event){return _vm.cellDblclick('industryMark')}}},[_vm._v(_vm._s(_vm.standardData[_vm.tTab.currStep-1].detailTabTabel[_vm.tTab.active-1].industryMark))])],1)],1)],1)],1),_vm._v(" "),_c('el-row',{staticClass:"prev_next_wrap"},[_c('el-button',{ref:"prev",attrs:{"size":"mini","type":"primary","disabled":_vm.tTab.currStep<=1?true:false},on:{"click":_vm.prevStep}},[_vm._v("上一步")]),_vm._v(" "),_c('el-button',{ref:"next",attrs:{"size":"mini","type":"primary","disabled":_vm.tTab.currStep>=_vm.standardData.length?true:false},on:{"click":_vm.nextStep}},[_vm._v("下一步")])],1),_vm._v(" "),_c('el-row',[_c('div',{ref:"nodeData",staticClass:"itable",attrs:{"id":"nodeData"}})]),_vm._v(" "),_c('el-row'),_vm._v(" "),_c('el-dialog',{staticClass:"dlg_details",attrs:{"title":_vm.tTabList[_vm.tTab.active - 1].name,"visible":_vm.detailDlg,"width":"80%","close-on-click-modal":false},on:{"update:visible":function($event){_vm.detailDlg=$event}}},[_c('div',{staticClass:"table table_wrap",staticStyle:{"padding":"10px 20px"}},[_c('el-table',{staticStyle:{"width":"100%"},attrs:{"data":_vm.detailsData,"border":"","tooltip-effect":"light","highlight-current-row":""}},[_c('el-table-column',{key:"link",attrs:{"fixed":"","prop":"link","label":"环节","width":"120"}}),_vm._v(" "),_vm._l((_vm.detailsTHead),function(item,i){return _c('el-table-column',{key:'step'+i,attrs:{"prop":item.key,"label":item.label,"width":"120","show-overflow-tooltip":""},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_vm._v(" "+_vm._s(scope.row[scope.column.property]))]}}],null,true)})})],2)],1),_vm._v(" "),_c('span',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{attrs:{"type":"primary","size":"mini"},on:{"click":_vm.exportData}},[_vm._v("导出")]),_vm._v(" "),_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){_vm.detailDlg = false}}},[_vm._v("关闭")])],1)])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_676f3e92_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(512);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-676f3e92"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_676f3e92_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vuex_demo_wrap"})}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"code_demo_wrap"},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isShowDemo),expression:"!isShowDemo"}],staticClass:"demo_list"},[_c('el-row',[_c('el-link',{staticClass:"name",on:{"click":function($event){return _vm.showDemo('1')}}},[_vm._v("元素宽度可拉伸")]),_vm._v(" "),_c('el-link',{staticClass:"name",on:{"click":function($event){return _vm.showDemo('2')}}},[_vm._v("流程图")])],1)],1),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isShowDemo),expression:"isShowDemo"}],staticClass:"demo_wrap"},[_c('el-row',[_c('el-button',{attrs:{"type":"text"},on:{"click":_vm.backDemoList}},[_vm._v("<<返回列表")])],1),_vm._v(" "),_c('el-row',[(_vm.activeDemo == '1')?_c('elWidthChange'):_vm._e(),_vm._v(" "),(_vm.activeDemo == '2')?_c('flowChart'):_vm._e(),_vm._v(" "),(_vm.activeDemo == '3')?_c('vuex'):_vm._e()],1)],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":24}})],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_elWidthChange_vue__ = __webpack_require__(226);
/* unused harmony namespace reexport */
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_48758563_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(525);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-48758563"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_48758563_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_elWidthChange_vue__ = __webpack_require__(228);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_372f717b_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_elWidthChange_vue__ = __webpack_require__(524);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-372f717b"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_elWidthChange_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_372f717b_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_elWidthChange_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue_code_learn_wrap"},[_vm._v("\n        ⇒  "),_c('br'),_vm._v("\n        →\n        "),_c('el-row',[_c('h3',{staticClass:"modal_t",on:{"click":function($event){return _vm.openCloseModal(1)}}},[_vm._v("1、源码目录")]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.openModal.modal1),expression:"openModal.modal1"}],staticClass:"border_radius"},[_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n├─dist                   "),_c('span',{staticClass:"note"},[_vm._v("# 项目构建后的文件")]),_vm._v("\n├─scripts                "),_c('span',{staticClass:"note"},[_vm._v("# 与项目构建相关的脚本和配置文件")]),_vm._v("\n├─flow                   "),_c('span',{staticClass:"note"},[_vm._v("# flow的类型声明文件")]),_vm._v("\n├─src                    "),_c('span',{staticClass:"note"},[_vm._v("# 项目源代码")]),_vm._v("\n│    ├─complier          "),_c('span',{staticClass:"note"},[_vm._v("# 与模板编译相关的代码")]),_vm._v("\n│    ├─core              "),_c('span',{staticClass:"note"},[_vm._v("# 通用的、与运行平台无关的运行时代码")]),_vm._v("\n│    │  ├─observe        "),_c('span',{staticClass:"note"},[_vm._v("# 实现变化侦测的代码")]),_vm._v("\n│    │  ├─vdom           "),_c('span',{staticClass:"note"},[_vm._v("# 实现virtual dom的代码")]),_vm._v("\n│    │  ├─instance       "),_c('span',{staticClass:"note"},[_vm._v("# Vue.js实例的构造函数和原型方法")]),_vm._v("\n│    │  ├─global-api     "),_c('span',{staticClass:"note"},[_vm._v("# 全局api的代码")]),_vm._v("\n│    │  └─components     "),_c('span',{staticClass:"note"},[_vm._v("# 内置组件的代码")]),_vm._v("\n│    ├─server            "),_c('span',{staticClass:"note"},[_vm._v("# 与服务端渲染相关的代码")]),_vm._v("\n│    ├─platforms         "),_c('span',{staticClass:"note"},[_vm._v("# 特定运行平台的代码，如weex")]),_vm._v("\n│    ├─sfc               "),_c('span',{staticClass:"note"},[_vm._v("# 单文件组件的解析代码")]),_vm._v("\n│    └─shared            "),_c('span',{staticClass:"note"},[_vm._v("# 项目公用的工具代码")]),_vm._v("\n└─test                   "),_c('span',{staticClass:"note"},[_vm._v("# 项目测试代码")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])])])]),_vm._v(" "),_c('el-row',[_c('h3',{staticClass:"modal_t",on:{"click":function($event){return _vm.openCloseModal(2)}}},[_vm._v("2、变化侦测")]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.openModal.modal2),expression:"openModal.modal2"}],staticClass:"border_radius"},[_c('p',[_c('font',{attrs:{"color":"red"}},[_c('strong',[_vm._v("UI = render(state)")])])],1),_vm._v(" "),_c('p',[_vm._v("状态"),_c('code',[_vm._v("state")]),_vm._v("是输入，页面"),_c('code',[_vm._v("UI")]),_vm._v("输出，状态输入一旦变化了，页面输出也随之而变化")]),_vm._v(" "),_c('h4',[_vm._v("1、使Object数据变得“可观测”")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" car "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token string"},[_vm._v("'brand'")]),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token string"},[_vm._v("'BMW'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token string"},[_vm._v("'price'")]),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token number"},[_vm._v("3000")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("使用"),_c('code',[_vm._v("Object.defineProperty()")]),_vm._v("改写：")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" car "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("3000")]),_vm._v("\nObject"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("defineProperty")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("car"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token string"},[_vm._v("'price'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  enumerable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  configurable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("get")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    console"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("log")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token string"},[_vm._v("'price属性被读取了'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" val\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("set")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    console"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("log")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token string"},[_vm._v("'price属性被修改了'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" newVal\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("通过"),_c('code',[_vm._v("Object.defineProperty()")]),_vm._v("方法给"),_c('code',[_vm._v("car")]),_vm._v("定义了一个"),_c('code',[_vm._v("price")]),_vm._v("属性，并把这个属性的读和写分别使用"),_c('code',[_vm._v("get()")]),_vm._v("和"),_c('code',[_vm._v("set()")]),_vm._v("进行拦截，每当该属性进行读或写操作的时候就会触发"),_c('code',[_vm._v("get()")]),_vm._v("和"),_c('code',[_vm._v("set()")]),_vm._v("。")]),_vm._v(" "),_c('h4',[_vm._v("2、observer 类")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 源码位置：src/core/observer/index.js")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * Observer类会通过递归的方式把一个对象的所有属性都转化成可观测对象\n */")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("class")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("constructor")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("value")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" value\n    "),_c('span',{staticClass:"token comment"},[_vm._v("// 给value新增一个__ob__属性，值为该value的Observer实例")]),_vm._v("\n    "),_c('span',{staticClass:"token comment"},[_vm._v("// 相当于为value打上标记，表示它已经被转化成响应式了，避免重复操作")]),_vm._v("\n    "),_c('span',{staticClass:"token function"},[_vm._v("def")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token string"},[_vm._v("'__ob__'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("Array"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("isArray")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token comment"},[_vm._v("// 当value为数组时的逻辑")]),_vm._v("\n      "),_c('span',{staticClass:"token comment"},[_vm._v("// ...")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("else")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("walk")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n\n  "),_c('span',{staticClass:"token function"},[_vm._v("walk")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("obj"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" Object")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" keys "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("keys")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("for")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("0")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("<")]),_vm._v(" keys"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i"),_c('span',{staticClass:"token operator"},[_vm._v("++")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token function"},[_vm._v("defineReactive")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" keys"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("i"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * 使一个对象转化成可观测对象\n * @param { Object } obj 对象\n * @param { String } key 对象的key\n * @param { Any } val 对象的某个key的值\n */")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("defineReactive")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("key"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("val")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token comment"},[_vm._v("// 如果只传了obj和key，那么val = obj[key]")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arguments"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("2")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" obj"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("key"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("typeof")]),_vm._v(" val "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" "),_c('span',{staticClass:"token string"},[_vm._v("'object'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("new")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("val"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("defineProperty")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" key"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    enumerable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    configurable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("get")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      console"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("log")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token template-string"},[_c('span',{staticClass:"token template-punctuation string"},[_vm._v("`")]),_c('span',{staticClass:"token interpolation"},[_c('span',{staticClass:"token interpolation-punctuation punctuation"},[_vm._v("${")]),_vm._v("key"),_c('span',{staticClass:"token interpolation-punctuation punctuation"},[_vm._v("}")])]),_c('span',{staticClass:"token string"},[_vm._v("属性被读取了")]),_c('span',{staticClass:"token template-punctuation string"},[_vm._v("`")])]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" val"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("set")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("val "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n          "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v("\n      "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n      console"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("log")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token template-string"},[_c('span',{staticClass:"token template-punctuation string"},[_vm._v("`")]),_c('span',{staticClass:"token interpolation"},[_c('span',{staticClass:"token interpolation-punctuation punctuation"},[_vm._v("${")]),_vm._v("key"),_c('span',{staticClass:"token interpolation-punctuation punctuation"},[_vm._v("}")])]),_c('span',{staticClass:"token string"},[_vm._v("属性被修改了")]),_c('span',{staticClass:"token template-punctuation string"},[_vm._v("`")])]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_c('code',[_vm._v("observer")]),_vm._v("类，它用来将一个正常的"),_c('code',[_vm._v("object")]),_vm._v("转换成可观测的"),_c('code',[_vm._v("object")]),_vm._v("。")]),_vm._v(" "),_c('p',[_vm._v("可以这样定义"),_c('code',[_vm._v("car")]),_vm._v(":")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" car "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("new")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token string"},[_vm._v("'brand'")]),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token string"},[_vm._v("'BMW'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token string"},[_vm._v("'price'")]),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token number"},[_vm._v("3000")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('h4',[_vm._v("3、依赖收集")]),_vm._v(" "),_c('p',[_vm._v("在"),_c('code',[_vm._v("getter")]),_vm._v("中收集依赖，在"),_c('code',[_vm._v("setter")]),_vm._v("中通知依赖更新。")]),_vm._v(" "),_c('p',[_c('code',[_vm._v("Dep")]),_vm._v("类 → 依赖管理器")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 源码位置：src/core/observer/dep.js")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("default")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("class")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Dep")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("constructor")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("subs "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n\n  "),_c('span',{staticClass:"token function"},[_vm._v("addSub")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("sub")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("subs"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("push")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("sub"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token comment"},[_vm._v("// 删除一个依赖")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("removeSub")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("sub")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token function"},[_vm._v("remove")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("subs"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" sub"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token comment"},[_vm._v("// 添加一个依赖")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("depend")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("window"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("target"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("addSub")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("window"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("target"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token comment"},[_vm._v("// 通知所有依赖更新")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("notify")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" subs "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("subs"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("slice")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("for")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("0")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" l "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" subs"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("<")]),_vm._v(" l"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i"),_c('span',{staticClass:"token operator"},[_vm._v("++")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      subs"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("i"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("update")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * Remove an item from an array\n */")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("remove")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("arr"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" item")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arr"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" index "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" arr"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("indexOf")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("item"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("index "),_c('span',{staticClass:"token operator"},[_vm._v(">")]),_vm._v(" "),_c('span',{staticClass:"token operator"},[_vm._v("-")]),_c('span',{staticClass:"token number"},[_vm._v("1")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" arr"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("splice")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("index"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("1")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("有了依赖管理器后，就可以在getter中收集依赖，在setter中通知依赖更新了，代码如下：")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("defineReactive")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("key"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("val")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arguments"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("2")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" obj"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("key"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("typeof")]),_vm._v(" val "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" "),_c('span',{staticClass:"token string"},[_vm._v("'object'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("new")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("val"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" dep "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("new")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Dep")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("  "),_c('span',{staticClass:"token comment"},[_vm._v("//实例化一个依赖管理器，生成一个依赖管理数组dep")]),_vm._v("\n  Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("defineProperty")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" key"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    enumerable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    configurable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("get")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      dep"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("depend")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("    "),_c('span',{staticClass:"token comment"},[_vm._v("// 在getter中收集依赖")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" val"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("set")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("val "),_c('span',{staticClass:"token operator"},[_vm._v("===")]),_vm._v(" newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n          "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v("\n      "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n      val "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" newVal"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      dep"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("notify")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("   "),_c('span',{staticClass:"token comment"},[_vm._v("// 在setter中通知依赖更新")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('h4',[_vm._v("4、Watcher 类")]),_vm._v(" "),_c('p',[_vm._v("谁用到了数据，谁就是依赖，我们就为谁创建一个"),_c('code',[_vm._v("Watcher")]),_vm._v("实例。")]),_vm._v(" "),_c('p',[_c('code',[_vm._v("Watcher")]),_vm._v("类的具体实现如下：")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("default")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("class")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Watcher")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token function"},[_vm._v("constructor")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("vm"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("expOrFn"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("cb")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("vm "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" vm"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("cb "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" cb"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("getter "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("parsePath")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("expOrFn"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("get")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("get")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      window"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("target "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" vm "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("vm\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("getter")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("call")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("vm"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" vm"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n      window"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("target "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("undefined")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" value\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n    "),_c('span',{staticClass:"token function"},[_vm._v("update")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" oldValue "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("get")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("cb")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("call")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("vm"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" oldValue"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  \n  "),_c('span',{staticClass:"token comment"},[_vm._v("/**\n   * Parse simple path.\n   * 把一个形如'data.a.b.c'的字符串路径所表示的值，从真实的data对象中取出来\n   * 例如：\n   * data = {a:{b:{c:2}}}\n   * parsePath('a.b.c')(data)  // 2\n   */")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" bailRE "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token regex"},[_vm._v("/[^\\w.$]/")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("parsePath")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("path")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("bailRE"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("test")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("path"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" segments "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" path"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("split")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token string"},[_vm._v("'.'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("obj")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("for")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("0")]),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("<")]),_vm._v(" segments"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i"),_c('span',{staticClass:"token operator"},[_vm._v("++")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n        "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token operator"},[_vm._v("!")]),_vm._v("obj"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v("\n        obj "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" obj"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("segments"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("i"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n      "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" obj\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("在创建"),_c('code',[_vm._v("Watcher")]),_vm._v("实例的过程中会自动的把自己添加到这个数据对应的依赖管理器中。")]),_vm._v(" "),_c('p',[_c('code',[_vm._v("Watcher")]),_vm._v("类的代码实现逻辑：")]),_vm._v(" "),_c('ol',[_c('li',[_vm._v("当实例化"),_c('code',[_vm._v("Watcher")]),_vm._v("类时，会先执行其构造函数；")]),_vm._v(" "),_c('li',[_vm._v("在构造函数中调用了"),_c('code',[_vm._v("this.get()")]),_vm._v("实例方法；")]),_vm._v(" "),_c('li',[_vm._v("在"),_c('code',[_vm._v("get()")]),_vm._v("方法中，首先通过"),_c('code',[_vm._v("window.target = this")]),_vm._v("把实例自身赋给了全局的一个唯一对象"),_c('code',[_vm._v("window.target")]),_vm._v("上，然后通过"),_c('code',[_vm._v("let value = this.getter.call(vm, vm)")]),_vm._v("获取一下被依赖的数据，获取被依赖数据的目的是触发该数据上面的"),_c('code',[_vm._v("getter")]),_vm._v("，上文我们说过，在"),_c('code',[_vm._v("getter")]),_vm._v("里会调用"),_c('code',[_vm._v("dep.depend()")]),_vm._v("收集依赖，而在"),_c('code',[_vm._v("dep.depend()")]),_vm._v("中取到挂载"),_c('code',[_vm._v("window.target")]),_vm._v("上的值并将其存入依赖数组中，在"),_c('code',[_vm._v("get()")]),_vm._v("方法最后将"),_c('code',[_vm._v("window.target")]),_vm._v("释放掉。")]),_vm._v(" "),_c('li',[_vm._v("而当数据变化时，会触发数据的"),_c('code',[_vm._v("setter")]),_vm._v("，在"),_c('code',[_vm._v("setter")]),_vm._v("中调用了"),_c('code',[_vm._v("dep.notify()")]),_vm._v("方法，在"),_c('code',[_vm._v("dep.notify()")]),_vm._v("方法中，遍历所有依赖(即watcher实例)，执行依赖的"),_c('code',[_vm._v("update()")]),_vm._v("方法，也就是"),_c('code',[_vm._v("Watcher")]),_vm._v("类中的"),_c('code',[_vm._v("update()")]),_vm._v("实例方法，在"),_c('code',[_vm._v("update()")]),_vm._v("方法中调用数据变化的更新回调函数，从而更新视图。")])]),_vm._v(" "),_c('p',[_c('code',[_vm._v("Watcher")]),_vm._v("先把自己设置到全局唯一的指定位置（"),_c('code',[_vm._v("window.target")]),_vm._v("），然后读取数据。因为读取了数据，所以会触发这个数据的"),_c('code',[_vm._v("getter")]),_vm._v("。接着，在"),_c('code',[_vm._v("getter")]),_vm._v("中就会从全局唯一的那个位置读取当前正在读取数据的"),_c('code',[_vm._v("Watcher")]),_vm._v("，并把这个"),_c('code',[_vm._v("watcher")]),_vm._v("收集到"),_c('code',[_vm._v("Dep")]),_vm._v("中去。收集好之后，当数据发生变化时，会向"),_c('code',[_vm._v("Dep")]),_vm._v("中的每个"),_c('code',[_vm._v("Watcher")]),_vm._v("发送通知。")]),_vm._v(" "),_c('img',{attrs:{"src":"https://vue-js.com/learn-vue/assets/img/3.0b99330d.jpg","alt":"关系流程图"}}),_vm._v(" "),_c('h4',[_vm._v("5、总结")]),_vm._v(" "),_c('ol',[_c('li',[_c('code',[_vm._v("Data")]),_vm._v("通过"),_c('code',[_vm._v("observer")]),_vm._v("转换成了"),_c('code',[_vm._v("getter/setter")]),_vm._v("的形式来追踪变化。")]),_vm._v(" "),_c('li',[_vm._v("当外界通过"),_c('code',[_vm._v("Watcher")]),_vm._v("读取数据时，会触发"),_c('code',[_vm._v("getter")]),_vm._v("从而将"),_c('code',[_vm._v("Watcher")]),_vm._v("添加到依赖中。")]),_vm._v(" "),_c('li',[_vm._v("当数据发生了变化时，会触发"),_c('code',[_vm._v("setter")]),_vm._v("，从而向"),_c('code',[_vm._v("Dep")]),_vm._v("中的依赖（即Watcher）发送通知。")]),_vm._v(" "),_c('li',[_c('code',[_vm._v("Watcher")]),_vm._v("接收到通知后，会向外界发送通知，变化通知到外界后可能会触发视图更新，也有可能触发用户的某个回调函数等。")])]),_vm._v(" "),_c('p'),_vm._v(" "),_c('h4',[_vm._v("6、Array 的变化侦测")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token function"},[_vm._v("data")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      arr"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_c('span',{staticClass:"token number"},[_vm._v("1")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token number"},[_vm._v("2")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token number"},[_vm._v("3")]),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_c('code',[_vm._v("arr")]),_vm._v("这个数据始终都存在于一个"),_c('code',[_vm._v("object")]),_vm._v("数据对象中，要用到"),_c('code',[_vm._v("arr")]),_vm._v("这个数据，得先从"),_c('code',[_vm._v("object")]),_vm._v("数据对象中获取一下"),_c('code',[_vm._v("arr")]),_vm._v("数据，而从"),_c('code',[_vm._v("object")]),_vm._v("数据对象中获取"),_c('code',[_vm._v("arr")]),_vm._v("数据自然就会触发"),_c('code',[_vm._v("arr")]),_vm._v("的"),_c('code',[_vm._v("getter")]),_vm._v("，所以在"),_c('code',[_vm._v("getter")]),_vm._v("中收集依赖。")]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Array型数据还是在getter中收集依赖。")])]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" arr "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_c('span',{staticClass:"token number"},[_vm._v("1")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token number"},[_vm._v("2")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_c('span',{staticClass:"token number"},[_vm._v("3")]),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\narr"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("push")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token number"},[_vm._v("4")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n"),_c('span',{staticClass:"token class-name"},[_vm._v("Array")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("prototype"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function-variable function"},[_vm._v("newPush")]),_vm._v(" "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("val")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  console"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("log")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token string"},[_vm._v("'arr被修改了'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("push")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("val"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\narr"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("newPush")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token number"},[_vm._v("4")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("针对数组的原生"),_c('code',[_vm._v("push")]),_vm._v("方法定义个一个新的"),_c('code',[_vm._v("newPush")]),_vm._v("方法，这个"),_c('code',[_vm._v("newPush")]),_vm._v("方法内部调用了原生"),_c('code',[_vm._v("push")]),_vm._v("方法，这样就保证了新的"),_c('code',[_vm._v("newPush")]),_vm._v("方法跟原生"),_c('code',[_vm._v("push")]),_vm._v("方法具有相同的功能，而且还可以在新的"),_c('code',[_vm._v("newPush")]),_vm._v("方法内部干一些别的事情，比如通知变化。")]),_vm._v(" "),_c('p',[_vm._v("（1）数组方法拦截器")]),_vm._v(" "),_c('p',[_vm._v("在"),_c('code',[_vm._v("Vue")]),_vm._v("中创建了一个数组方法拦截器，它拦截在数组实例与"),_c('code',[_vm._v("Array.prototype")]),_vm._v("之间，在拦截器内重写了操作数组的一些方法，当数组实例使用操作数组方法时，其实使用的是拦截器中重写的方法，而不再使用"),_c('code',[_vm._v("Array.prototype")]),_vm._v("上的原生方法。如下图所示：")]),_vm._v(" "),_c('img',{attrs:{"src":"https://vue-js.com/learn-vue/assets/img/2.b446ab83.png","alt":""}}),_vm._v(" "),_c('p',[_c('code',[_vm._v("Array")]),_vm._v("原型中可以改变数组自身内容的方法有："),_c('code',[_vm._v("push")]),_vm._v(","),_c('code',[_vm._v("pop")]),_vm._v(","),_c('code',[_vm._v("shift")]),_vm._v(","),_c('code',[_vm._v("unshift")]),_vm._v(","),_c('code',[_vm._v("splice")]),_vm._v(","),_c('code',[_vm._v("sort")]),_vm._v(","),_c('code',[_vm._v("reverse")]),_vm._v("。源码中的拦截器代码如下：")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 源码位置：/src/core/observer/array.js")]),_vm._v("\n\n"),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" arrayProto "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Array")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("prototype\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 创建一个对象作为拦截器")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" arrayMethods "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("create")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arrayProto"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 改变数组自身内容的7个方法")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" methodsToPatch "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'push'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'pop'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'shift'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'unshift'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'splice'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'sort'")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n  "),_c('span',{staticClass:"token string"},[_vm._v("'reverse'")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * Intercept mutating methods and emit events\n */")]),_vm._v("\nmethodsToPatch"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("forEach")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("method")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" original "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" arrayProto"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("method"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("      "),_c('span',{staticClass:"token comment"},[_vm._v("// 缓存原生方法")]),_vm._v("\n  Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("defineProperty")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arrayMethods"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" method"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    enumerable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("false")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    configurable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    writable"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" "),_c('span',{staticClass:"token boolean"},[_vm._v("true")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v("\n    "),_c('span',{staticClass:"token function-variable function"},[_vm._v("value")]),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("mutator")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_c('span',{staticClass:"token operator"},[_vm._v("...")]),_vm._v("args")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" result "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("original")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("apply")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" args"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("return")]),_vm._v(" result\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("→ 先创建了继承自"),_c('code',[_vm._v("Array")]),_vm._v("原型的空对象"),_c('code',[_vm._v("arrayMethods")])]),_vm._v(" "),_c('p',[_vm._v("→ 在"),_c('code',[_vm._v("arrayMethods")]),_vm._v("上使用"),_c('code',[_vm._v("object.defineProperty")]),_vm._v("方法将那些可以改变数组自身的7个方法遍历逐个进行封装。")]),_vm._v(" "),_c('p',[_vm._v("→ 当使用"),_c('code',[_vm._v("push")]),_vm._v("方法的时候，其实用的是"),_c('code',[_vm._v("arrayMethods.push")])]),_vm._v(" "),_c('p',[_vm._v("→ 而"),_c('code',[_vm._v("arrayMethods.push")]),_vm._v("就是封装的新函数"),_c('code',[_vm._v("mutator")])]),_vm._v(" "),_c('p',[_vm._v("→ 实标上执行的是函数"),_c('code',[_vm._v("mutator")]),_vm._v("，而"),_c('code',[_vm._v("mutator")]),_vm._v("函数内部执行了"),_c('code',[_vm._v("original")]),_vm._v("函数，这个"),_c('code',[_vm._v("original")]),_vm._v("函数就是"),_c('code',[_vm._v("Array.prototype")]),_vm._v("上对应的原生方法。")]),_vm._v(" "),_c('p',[_vm._v("→ 可以在"),_c('code',[_vm._v("mutato")]),_vm._v("r函数中做一些其他的事，比如说发送变化通知。")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('p',[_vm._v("（2）使用拦截器")]),_vm._v(" "),_c('p',[_vm._v("还要把它挂载到数组实例与"),_c('code',[_vm._v("Array.prototype")]),_vm._v("之间，这样拦截器才能够生效。")]),_vm._v(" "),_c('p',[_vm._v("只需把数据的"),_c('code',[_vm._v("__proto__")]),_vm._v("属性设置为拦截器"),_c('code',[_vm._v("arrayMethods")]),_vm._v("即可，源码实现如下：")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 源码位置：/src/core/observer/index.js")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("class")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("constructor")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("value")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" value\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("Array"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("isArray")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" augment "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" hasProto\n        "),_c('span',{staticClass:"token operator"},[_vm._v("?")]),_vm._v(" protoAugment\n        "),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" copyAugment\n      "),_c('span',{staticClass:"token function"},[_vm._v("augment")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" arrayMethods"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" arrayKeys"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("else")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("walk")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 能力检测：判断__proto__是否可用，因为有的浏览器不支持该属性")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" hasProto "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token string"},[_vm._v("'__proto__'")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("in")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n\n"),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" arrayKeys "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("getOwnPropertyNames")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("arrayMethods"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * Augment an target Object or Array by intercepting\n * the prototype chain using __proto__\n */")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("protoAugment")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("target"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" src"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" keys"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" any")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  target"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("__proto__ "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" src\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n\n"),_c('span',{staticClass:"token comment"},[_vm._v("/**\n * Augment an target Object or Array by defining\n * hidden properties.\n */")]),_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("/* istanbul ignore next */")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("function")]),_vm._v(" "),_c('span',{staticClass:"token function"},[_vm._v("copyAugment")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("target"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" src"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" Object"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" keys"),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" Array"),_c('span',{staticClass:"token operator"},[_vm._v("<")]),_vm._v("string"),_c('span',{staticClass:"token operator"},[_vm._v(">")])]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token keyword"},[_vm._v("for")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token keyword"},[_vm._v("let")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token number"},[_vm._v("0")]),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" l "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" keys"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("length"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i "),_c('span',{staticClass:"token operator"},[_vm._v("<")]),_vm._v(" l"),_c('span',{staticClass:"token punctuation"},[_vm._v(";")]),_vm._v(" i"),_c('span',{staticClass:"token operator"},[_vm._v("++")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" key "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" keys"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("i"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_vm._v("\n    "),_c('span',{staticClass:"token function"},[_vm._v("def")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("target"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" key"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" src"),_c('span',{staticClass:"token punctuation"},[_vm._v("[")]),_vm._v("key"),_c('span',{staticClass:"token punctuation"},[_vm._v("]")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("→ 首先判断了浏览器是否支持"),_c('code',[_vm._v("__proto__")])]),_vm._v(" "),_c('p',[_vm._v("→ 如果支持，则调用"),_c('code',[_vm._v("protoAugment")]),_vm._v("函数把"),_c('code',[_vm._v("value.__proto__ = arrayMethods")]),_vm._v("；")]),_vm._v(" "),_c('p',[_vm._v("→ 如果不支持，则调用"),_c('code',[_vm._v("copyAugment")]),_vm._v("函数把拦截器中重写的7个方法循环加入到"),_c('code',[_vm._v("value")]),_vm._v("上。")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('p',[_vm._v("（3）依赖收集")]),_vm._v(" "),_c('p',[_vm._v("数组数据也在"),_c('code',[_vm._v("Observer")]),_vm._v("类中收集依赖")]),_vm._v(" "),_c('div',{staticClass:"code_wrap"},[_c('pre',[_vm._v("                        "),_c('code',[_vm._v("\n"),_c('span',{staticClass:"token comment"},[_vm._v("// 源码位置：/src/core/observer/index.js")]),_vm._v("\n"),_c('span',{staticClass:"token keyword"},[_vm._v("export")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("class")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Observer")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n  "),_c('span',{staticClass:"token function"},[_vm._v("constructor")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token parameter"},[_vm._v("value")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("value "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" value\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_vm._v("dep "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("new")]),_vm._v(" "),_c('span',{staticClass:"token class-name"},[_vm._v("Dep")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("    "),_c('span',{staticClass:"token comment"},[_vm._v("// 实例化一个依赖管理器，用来收集数组依赖")]),_vm._v("\n    "),_c('span',{staticClass:"token keyword"},[_vm._v("if")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("Array"),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("isArray")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("const")]),_vm._v(" augment "),_c('span',{staticClass:"token operator"},[_vm._v("=")]),_vm._v(" hasProto\n        "),_c('span',{staticClass:"token operator"},[_vm._v("?")]),_vm._v(" protoAugment\n        "),_c('span',{staticClass:"token operator"},[_vm._v(":")]),_vm._v(" copyAugment\n      "),_c('span',{staticClass:"token function"},[_vm._v("augment")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" arrayMethods"),_c('span',{staticClass:"token punctuation"},[_vm._v(",")]),_vm._v(" arrayKeys"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v(" "),_c('span',{staticClass:"token keyword"},[_vm._v("else")]),_vm._v(" "),_c('span',{staticClass:"token punctuation"},[_vm._v("{")]),_vm._v("\n      "),_c('span',{staticClass:"token keyword"},[_vm._v("this")]),_c('span',{staticClass:"token punctuation"},[_vm._v(".")]),_c('span',{staticClass:"token function"},[_vm._v("walk")]),_c('span',{staticClass:"token punctuation"},[_vm._v("(")]),_vm._v("value"),_c('span',{staticClass:"token punctuation"},[_vm._v(")")]),_vm._v("\n    "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n  "),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n"),_c('span',{staticClass:"token punctuation"},[_vm._v("}")]),_vm._v("\n                        ")]),_vm._v("\n                    ")])]),_vm._v(" "),_c('p',[_vm._v("→ ")]),_vm._v(" "),_c('p',[_vm._v("→ ")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p'),_vm._v(" "),_c('p')])]),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":24}})],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_travel01_vue__ = __webpack_require__(230);
/* unused harmony namespace reexport */
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3ad05f18_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(546);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3ad05f18"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3ad05f18_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_version01_vue__ = __webpack_require__(232);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_version02_vue__ = __webpack_require__(233);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_version03_vue__ = __webpack_require__(234);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4d98c228_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_version03_vue__ = __webpack_require__(542);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4d98c228"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4d98c228_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_version03_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_version04_vue__ = __webpack_require__(235);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1cefab5e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_version04_vue__ = __webpack_require__(545);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1cefab5e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_version04_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1cefab5e_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_version04_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"version_03_wrap"},[_vm._m(0),_vm._v(" "),_c('el-divider',{attrs:{"content-position":"left"}},[_vm._v("教育背景")]),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('el-divider',{attrs:{"content-position":"left"}},[_vm._v("专业技能")]),_vm._v(" "),_vm._m(2),_vm._v(" "),_c('el-divider',{attrs:{"content-position":"left"}},[_vm._v("工作经历")]),_vm._v(" "),_c('div',{staticClass:"modal_wrap work_wrap"},[_c('el-timeline',_vm._l((_vm.workExperienceData),function(item,i){return _c('el-timeline-item',{key:i,attrs:{"icon":item.icon,"type":item.type,"color":item.color,"size":item.size,"timestamp":item.time}},[_vm._v("\n                  "+_vm._s(item.company + '  ' + item.post)+"\n                ")])}),1)],1),_vm._v(" "),_vm._m(3),_vm._v(" "),_c('el-divider',{attrs:{"content-position":"left"}},[_vm._v("项目经验")]),_vm._v(" "),_c('div',{staticClass:"modal_wrap project_wrap"},[_c('el-timeline',_vm._l((_vm.projectData),function(item,i){return _c('el-timeline-item',{key:i,attrs:{"icon":item.icon,"type":item.type,"color":item.color,"size":item.size,"timestamp":item.time}},[_c('h3',{domProps:{"textContent":_vm._s(item.name)}}),_vm._v(" "),_c('dl',[_c('dt',[_vm._v("项目描述：")]),_vm._v(" "),_c('dd',{domProps:{"innerHTML":_vm._s(item.discript)}}),_vm._v(" "),_c('dt',[_vm._v("责任描述：")]),_vm._v(" "),_c('dd',{domProps:{"innerHTML":_vm._s(item.workContent)}})])])}),1)],1),_vm._v(" "),_c('el-divider',{attrs:{"content-position":"left"}},[_vm._v("自我评价")]),_vm._v(" "),_vm._m(4)],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"modal_wrap basic_info"},[_c('h1',{staticClass:"t_a_c"},[_vm._v("邱凤鸣    Web前端开发工程师")]),_vm._v(" "),_c('table',{staticClass:"basic_info_t"},[_c('tbody',[_c('tr',[_c('td',{staticClass:"t_a_r"},[_vm._v("1994年11月")]),_vm._v(" "),_c('td',{staticClass:"t_a_l"},[_vm._v("15820434189")])]),_vm._v(" "),_c('tr',[_c('td',{staticClass:"t_a_r"},[_vm._v("籍贯：广西")]),_vm._v(" "),_c('td',{staticClass:"t_a_l"})]),_vm._v(" "),_c('tr',[_c('td',{staticClass:"t_a_r"},[_vm._v("现居：深圳")]),_vm._v(" "),_c('td',{staticClass:"t_a_l"})]),_vm._v(" "),_c('tr',[_c('td',{staticClass:"t_a_r"},[_vm._v("学历：本科")]),_vm._v(" "),_c('td',{staticClass:"t_a_l"},[_vm._v("cily_qfm@163.com")])])])]),_vm._v(" "),_c('div',{staticClass:"t_a_c img_wrap"},[_c('img',{staticStyle:{"width":"100%"},attrs:{"src":"https://i.51job.com/resume/ajax/image.php?type=avatar&userid=411595042&1601310043&key=c412f5a23f801ddd3075ecc40bd8259c","alt":""}})])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"modal_wrap education_wrap"},[_c('table',[_c('tbody',[_c('tr',[_c('td',{staticClass:"t-a-r",attrs:{"width":"300"}},[_c('img',{attrs:{"src":"https://pt.tjpu.edu.cn/zfca/login/logo/logo_school.png","alt":"天津工业大学"}})]),_vm._v(" "),_c('td',[_c('h3',[_vm._v("2012-09 至 2016-06  天津工业大学")]),_vm._v(" "),_c('p',[_vm._v("学院：电子与信息工程学院")]),_vm._v(" "),_c('p',[_vm._v("专业：生物医学工程")])])])])])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"modal_wrap skill_wrap"},[_c('div',{staticClass:"border_radius"},[_c('dl',[_c('dt',[_c('label',{staticClass:"name"},[_vm._v("【基础技能】")])]),_vm._v(" "),_c('dd',[_vm._v("HTML(5)、CSS(3)、LESS、JavaScript、jQuery、VUE")]),_vm._v(" "),_c('dt',[_c('label',{staticClass:"name"},[_vm._v("【使用过的框架】")])]),_vm._v(" "),_c('dd',[_vm._v("jQuery + Bootstrap、jQuery + Jalor、VUE + Element UI")]),_vm._v(" "),_c('dt',[_c('label',{staticClass:"name"},[_vm._v("【使用过的插件】")])]),_vm._v(" "),_c('dd',[_vm._v("Bootstrap、jQuery-easyUI、Echarts、百度地图、Element UI")]),_vm._v(" "),_c('dt',[_c('label',{staticClass:"name"},[_vm._v("【了解】")])]),_vm._v(" "),_c('dd',[_vm._v("ES6、React、AngularJS、gulp、webpack、Photoshop、yarn、npm")])])])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('br'),_c('br')])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"modal_wrap self_evaluation_wrap"},[_c('ol',[_c('li',[_vm._v("适应能力较强，自制力较好，执行力强。")]),_vm._v(" "),_c('li',[_vm._v("性格开朗、自信热情、好学、有责任心、能吃苦耐劳、富有时间观念、有团队合作精神和集体荣誉感。")]),_vm._v(" "),_c('li',[_vm._v("优点：执行力强、工作认真、善于团队合作、好学、乐于助人、爱干净。")]),_vm._v(" "),_c('li',[_vm._v("缺点：急性子。")])])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"resume_wrap"},[_c('version04')],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(236);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_js_vue__ = __webpack_require__(237);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4ffcb8c2_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_js_vue__ = __webpack_require__(551);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4ffcb8c2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_js_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4ffcb8c2_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_js_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_es6_vue__ = __webpack_require__(238);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_vue_vue__ = __webpack_require__(239);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(240);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(241);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7e78dc1d_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(570);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7e78dc1d"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7e78dc1d_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"components_wrap"},[_c('router-view')],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_flowChart_js__ = __webpack_require__(244);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1b4970ec_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(574);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_flowChart_js__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1b4970ec_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flowchart_wrap"},[_c('el-tabs',{attrs:{"type":"card"},on:{"tab-click":_vm.handleClick},model:{value:(_vm.activeName),callback:function ($$v) {_vm.activeName=$$v},expression:"activeName"}},[_c('el-tab-pane',{attrs:{"label":"标准流程","name":"1"}}),_vm._v(" "),_c('el-tab-pane',{attrs:{"label":"自定义流程","name":"2"}})],1),_vm._v(" "),_c('el-row',{directives:[{name:"show",rawName:"v-show",value:(_vm.activeName == '2'),expression:"activeName == '2'"}],staticClass:"canvas_toolbar"},[_c('div',{ref:"section",staticClass:"section",attrs:{"id":"toolbar"}},[_c('el-button',{ref:"add",attrs:{"id":"add","size":"mini"},on:{"click":_vm.addUnit}},[_vm._v("新增图元")]),_vm._v(" "),_c('el-button',{ref:"del",attrs:{"id":"del","size":"mini"},on:{"click":_vm.delUnit}},[_vm._v("删除图元")]),_vm._v(" "),_c('el-button',{ref:"editProp",attrs:{"id":"editProp","size":"mini"},on:{"click":_vm.editUnit}},[_vm._v("编辑图元")]),_vm._v(" "),_c('el-button',{ref:"clear",attrs:{"id":"clear","size":"mini"},on:{"click":_vm.cleanUnit}},[_vm._v("清除画布")]),_vm._v(" "),_c('el-button',{ref:"standard",attrs:{"id":"standard","size":"mini"},on:{"click":_vm.loadStandard}},[_vm._v("加载标准流程")])],1)]),_vm._v(" "),_c('el-row',{staticClass:"flow_chart_wrap"},[_c('div',{ref:"flowChartBox",staticClass:"flow_chart_box",attrs:{"id":"flowChartBox"}},[_vm._l((_vm.standardData),function(item,i){return _c('div',{key:i,staticClass:"unit_wrap",style:({left: item.x+'px', top: item.y+'px'}),on:{"mouseenter":function($event){return _vm.enterUnit(item)},"mouseleave":function($event){return _vm.leaveUnit(item)},"click":function($event){return _vm.clickUnit('unit', item)},"mousedown":function($event){return _vm.mousedownUnit($event, item)},"mouseup":function($event){return _vm.mouseupUnit($event,item)}}},[(item.SN !='mouse')?_c('div',{staticClass:"unit",style:({'border-color': item.isSelect?'red':''})},[_c('p',{staticClass:"head",style:({'background-color': item.head.bgColor, color: item.head.color, 'font-family': item.head.fontFamily})},[_vm._v(_vm._s(item.head.text))]),_vm._v(" "),_c('div',{staticClass:"body",style:({'background-color': item.body.bgColor, color: item.body.color, 'font-family': item.body.fontFamily})},[_vm._v(_vm._s(item.body.text))]),_vm._v(" "),_c('p',{staticClass:"foot",style:({'background-color': item.footer.bgColor, color: item.footer.color, 'font-family': item.footer.fontFamily})},[_vm._v(_vm._s(item.footer.text))])]):_vm._e(),_vm._v(" "),(item.SN !='mouse')?_c('div',{directives:[{name:"show",rawName:"v-show",value:(item.showPoint),expression:"item.showPoint"}],staticClass:"point_wrap"},[_c('span',{staticClass:"point lTop",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'lTop')}}}),_vm._v(" "),_c('span',{staticClass:"point top",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'top')}}}),_vm._v(" "),_c('span',{staticClass:"point rTop",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'rTop')}}}),_vm._v(" "),_c('span',{staticClass:"point right",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'right')}}}),_vm._v(" "),_c('span',{staticClass:"point rBottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'rBottom')}}}),_vm._v(" "),_c('span',{staticClass:"point bottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'bottom')}}}),_vm._v(" "),_c('span',{staticClass:"point lBottom",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'lBottom')}}}),_vm._v(" "),_c('span',{staticClass:"point left",on:{"click":function($event){return _vm.clickPoint($event, item, i, 'left')}}})]):_vm._e()])}),_vm._v(" "),_c('div',{staticClass:"arrow_wrap"},[_vm._l((_vm.arrowArr),function(item,i){return _c('div',{key:i,staticClass:"arrow",style:({
                    width: item.width+'px', left: item.startX+8+'px', top: item.startY+8+'px', 
                    transform: 'rotate('+item.angle+'deg)', '-ms-transform': 'rotate('+item.angle+'deg)', '-webkit-transform': 'rotate('+item.angle+'deg)',
                    'background-color':item.isSelect?'red':''
                }),on:{"click":function($event){$event.stopPropagation();return _vm.clickUnit('arrow', item)}}},[_c('div',{staticClass:"arrow_r",style:({ 'border-left-color':item.isSelect?'red':'' }),on:{"click":function($event){$event.stopPropagation();return _vm.clickUnit('arrow', item)}}})])}),_vm._v(" "),(_vm.newArrow!==null)?_c('div',{staticClass:"arrow arrow_r",style:({
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_A_vue__ = __webpack_require__(245);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2dfcfdf1_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_A_vue__ = __webpack_require__(577);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-2dfcfdf1"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_A_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2dfcfdf1_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_A_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"codedemo_vuex_a"},[_c('P',{staticClass:"title"},[_vm._v("组件A")]),_vm._v(" "),_c('P',{staticClass:"titleName"},[_vm._v("餐馆名称："+_vm._s(_vm.resturantName))]),_vm._v(" "),_c('div',[_c('button',{staticClass:"btn",on:{"click":function($event){return _vm.modifyAName('A餐馆')}}},[_vm._v("修改为A餐馆")])]),_vm._v(" "),_c('div',{staticClass:"marTop"},[_c('button',{staticClass:"btn",on:{"click":_vm.trunToB}},[_vm._v("跳转到B页面")])])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_B_vue__ = __webpack_require__(246);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c4da759_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_B_vue__ = __webpack_require__(580);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6c4da759"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_B_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c4da759_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_B_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"codedemo_vuex_b"},[_c('P',{staticClass:"title"},[_vm._v("组件B")]),_vm._v(" "),_c('P',{staticClass:"titleName"},[_vm._v("餐馆名称："+_vm._s(_vm.resturantName))]),_vm._v(" "),_c('div',[_c('button',{staticClass:"btn",on:{"click":function($event){return _vm.modifyBName('B餐馆')}}},[_vm._v("修改为B餐馆")])]),_vm._v(" "),_c('div',{staticClass:"marTop"},[_c('button',{staticClass:"btn",on:{"click":_vm.trunToA}},[_vm._v("跳转到A页面")])])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__getters__ = __webpack_require__(584);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(585);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(586);
...
var state = {
    ...
    getters: __WEBPACK_IMPORTED_MODULE_2__getters__, // 获取数据并渲染
    actions: __WEBPACK_IMPORTED_MODULE_3__actions__, // 数据的异步操作
    mutations: __WEBPACK_IMPORTED_MODULE_4__mutations__ // 处理数据的唯一途径，state的改变或赋值只能在这里
});

/* harmony default export */ __webpack_exports__["a"] = (store); // 导出store并在 main.js中引用注册。
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resturantName", function() { return resturantName; });
...
// 获取最终的状态信息
var resturantName = function resturantName(state) {
  return state.resturantName;
};

// 路由 /works/docstructure 的数据
var navTree = function navTree(state) {
  return state.navTree;
};
var activeNav = function activeNav(state) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["modifyAName"] = modifyAName;
/* harmony export (immutable) */ __webpack_exports__["modifyBName"] = modifyBName;
/* harmony export (immutable) */ __webpack_exports__["updateNavTree"] = updateNavTree;
/* harmony export (immutable) */ __webpack_exports__["setActiveNav"] = setActiveNav;
// 给action注册事件处理函数。当这个函数被触发时候，将状态提交到mutations中处理
function modifyAName(_ref, name) {
    var commit = _ref.commit;
    // commit 提交；name即为点击后传递过来的参数，此时是 'A餐馆'
    return commit('modifyAName', name);
}
function modifyBName(_ref2, name) {
...
// 路由 /works/docstructure 的数据
function updateNavTree(_ref3, val) {
    var commit = _ref3.commit;

    return commit('updateNavTree', val);
}
function setActiveNav(_ref4, val) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modifyAName", function() { return modifyAName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modifyBName", function() { return modifyBName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateNavTree", function() { return updateNavTree; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateActiveNav", function() { return updateActiveNav; });
// 提交 mutations是更改Vuex状态的唯一合法方法
var modifyAName = function modifyAName(state, name) {
    // A组件点击更改餐馆名称为 A餐馆
    state.resturantName = name; // 把方法传递过来的参数，赋值给state中的resturantName
};
var modifyBName = function modifyBName(state, name) {
    // B组件点击更改餐馆名称为 B餐馆
    state.resturantName = name;
};

// 路由 /works/docstructure 的数据
var updateNavTree = function updateNavTree(state, val) {
    state.navTree = val;
};
var updateActiveNav = function updateActiveNav(state, val) {
    state.activeNav = val;
};
...
//# sourceMappingURL=app.bf5e11169feca8eef4c3.js.map